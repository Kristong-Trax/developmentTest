...
from Projects.DIAGEOES.Tests.Data.data_test_diageoes_sanity import ProjectsSanityData
from Projects.DIAGEOES.Calculations import DIAGEOESCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.DIAGEOES.Tests.Data.kpi_results import DIAGEOESKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["diageoes_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_diageoes_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {u'23FC44D2-BBE8-477C-800D-C35F103A0C2B': []}
        kpi_results = DIAGEOESKpiResults().get_kpi_results()
