...
from Projects.DIAGEOES.Utils.ToolBox import DIAGEOToolBox
...
class DIAGEOESToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOToolBox(self.data_provider, output, kpi_static_data=self.kpi_static_data,
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOESQueries.get_match_display(self.session_uid)
