...
class SosBrandOutOfStore(UnifiedCalculationsScript):

    def __init__(self, data_provider, config_params=None, **kwargs):
        super(SosBrandOutOfStore, self).__init__(data_provider, config_params=config_params, **kwargs)
        self.util = DiageoUtil(data_provider)

    def kpi_type(self):
        return'SOS OUT OF STORE'
    ...
    def calculate(self):
        ...
        res_list = []
        sos_fk = self.util.commonV2.get_kpi_fk_by_kpi_name('SOS OUT OF STORE')
