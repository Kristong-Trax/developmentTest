...
class SosSubCategoryOutOfCategory(UnifiedCalculationsScript):

    def __init__(self, data_provider, config_params=None, **kwargs):
        super(SosSubCategoryOutOfCategory, self).__init__(data_provider, config_params=config_params, **kwargs)
        self.util = DiageoUtil(data_provider)

    def kpi_type(self):
        return'SOS SUB CATEGORY OUT OF CATEGORY'
    ...
    def calculate(self):
        ...
        res_list = []
        sos_fk = self.util.commonV2.get_kpi_fk_by_kpi_name('SOS SUB CATEGORY OUT OF CATEGORY')
