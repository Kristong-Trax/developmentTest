...
if __name__ == '__main__':
    ...
    sessions = [
        ...
        # '64345CEA-5A15-4919-8FB2-8A06C0DEA7EE',  # kinda works, but fails due to longest shelf being #6
        # need to discuss ^that because smokeless section doesn't exist.
        ...
        # '3FF91AAC-6008-4B4E-BAD1-1220C1A2A45D'  # unequal tags, and the smokeless section is above cigarettes
        # need to discuss the last session
