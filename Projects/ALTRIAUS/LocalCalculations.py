...
if __name__ == '__main__':
    ...
    sessions = [
        ...
        # '3EB3EEF7-CA5B-45D6-9D99-1D230B86ECC1',  # flip sign positional integer out of bounds
        # '6479848B-7A28-49F1-8568-B1CF4CC2A52F',  # works!
        # '64345CEA-5A15-4919-8FB2-8A06C0DEA7EE',  # problem in get_longest_shelf
        # 'C1822AEA-A997-414B-ADEF-5EA28BD3B915',  # problem in get_longest_shelf
        # '2987F99F-579B-4DD5-83A3-DB9C5C75FED5',  # problem in get_longest_shelf
        # '3FF91AAC-6008-4B4E-BAD1-1220C1A2A45D'  # unequal tags, probably irreparable
