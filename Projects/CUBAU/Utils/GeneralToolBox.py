...
from Projects.CUBAU.Utils.PositionGraph import CUBAUCUBAUPositionGraphs

__author__ = 'Nimrod'


class CUBAUCUBAUGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CUBAUCUBAUPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
