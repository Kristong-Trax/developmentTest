...
from Projects.NESTLEUK_SAND.Utils.ParseTemplates import parse_template
...
class NESTLEUK_SANDTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = NESTLEUK_SANDGENERALToolBox.get_json_data(file_path)
        else:
