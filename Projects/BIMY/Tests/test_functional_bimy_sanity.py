...
from Projects.BIMY.Tests.Data.data_test_bimy_sanity import ProjectsSanityData
from Projects.BIMY.Calculations import BIMYCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.BIMY.Tests.Data.kpi_results import BIMYKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["bimy_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_bimy_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'7e3b8f66-f599-4204-8d22-10dcd3c1cc05': []}
        kpi_results = BIMYKpiResults().get_kpi_results()
