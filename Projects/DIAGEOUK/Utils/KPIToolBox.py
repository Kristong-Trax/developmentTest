...
class DIAGEOUKToolBox:
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOUKQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOUKQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOUKQueries.get_delete_session_results_query(self.session_uid)
