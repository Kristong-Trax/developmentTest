...
from Projects.MARS_CHOCO_RU.Utils.KPIToolBox import MARS_CHOCO_RUMARSToolBox, log_runtime

__author__ = 'Sanad'


class MARS_CHOCO_RUMARSGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = MARS_CHOCO_RUMARSToolBox(self.data_provider, self.output)
