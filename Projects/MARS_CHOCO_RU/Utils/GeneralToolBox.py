...
from Projects.MARS_CHOCO_RU.Utils.PositionGraph import MARS_CHOCO_RUMARSPositionGraphs

__author__ = 'Nimrod'


class MARS_CHOCO_RUMARSGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = MARS_CHOCO_RUMARSPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUMARS_CHOCO_RUMARSGENERALToolBox.INCLUDE_FILTER)
