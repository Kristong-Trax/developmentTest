...
from Projects.DIAGEOGR_SAND.Utils.PositionGraph import DIAGEOGR_SANDPositionGraphs
...
class DIAGEOGR_SANDGENERALToolBox:
    """
    ...
    def __init__(self, data_provider, output, kpi_static_data, geometric_kpi_flag=False):
        ...
        if geometric_kpi_flag:
            self.position_graphs = DIAGEOGR_SANDPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOGR_SANDGENERALToolBox.INCLUDE_FILTER)
