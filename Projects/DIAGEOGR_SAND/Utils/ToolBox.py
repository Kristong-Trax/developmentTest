...
from Projects.DIAGEOGR_SAND.Utils.GeneralToolBox import DIAGEOGR_SANDGENERALToolBox
...
class DIAGEOGR_SANDDIAGEOToolBox:
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOGR_SANDGENERALToolBox(data_provider, output, self.kpi_static_data,
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOGR_SANDDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOGR_SANDDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOGR_SANDDIAGEOToolBox.DIAGEO
