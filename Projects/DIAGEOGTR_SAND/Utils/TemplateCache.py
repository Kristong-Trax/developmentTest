...
from Projects.DIAGEOGTR_SAND.Utils.ParseTemplates import parse_template
...
class DIAGEOGTRTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOGTRGENERALToolBox.get_json_data(file_path)
        else:
