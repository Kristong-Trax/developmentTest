...
from Projects.DIAGEOGA.Utils.GeneralToolBox import DIAGEOGADIAGEOGAGENERALToolBox
from Projects.DIAGEOGA.Utils.ParseTemplates import parse_template
...
class DIAGEOGADIAGEOGATemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOGADIAGEOGAGENERALToolBox.get_json_data(file_path)
        else:
