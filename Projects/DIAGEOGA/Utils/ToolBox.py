...
class DIAGEOGADIAGEOConsts(object):
...
class DIAGEOGADIAGEOToolBox(DIAGEOGADIAGEOConsts):
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOAUDIAGEOGADIAGEOToolBox.DIAGEO,
                                                                 DIAGEOAUDIAGEOGADIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOAUDIAGEOGADIAGEOToolBox.DIAGEO
