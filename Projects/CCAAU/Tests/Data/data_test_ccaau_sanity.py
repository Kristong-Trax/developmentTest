...
class ProjectsSanityData(BaseSeedData):
    ...
    ccaau_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                  FILES_RELATIVE_PATH: ['Data/Seeds/ccaau_seed.sql.gz'],
    ...
    custom_ccaau_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                      FILES_RELATIVE_PATH: ['Data/Seeds/ccaau_seed_alter_table.sql.gz'],
                      PROJECT_NAME: project_name
                      }