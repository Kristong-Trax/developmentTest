...
from Projects.CBCIL.Utils.SOS import OwnManufacturerSOSInStore,ManufacturerFacingsSOSPerCategory,BrandOutManufacturerOutCategoryFacingsSOS,SkuOutBrandOutCategoryFacingsSOS
...
class CBCILCBCIL_ToolBox(object):
    ...
    def __init__(self, data_provider, output):
        ...
        self.template_data = self.kpis_data[
            ...
            ((self.kpis_data[self.ADDITIONAL_ATTRIBUTE_1].str.encode('utf-8').isin(self.additional_attribute_1))| self.kpis_data[self.ADDITIONAL_ATTRIBUTE_1].str.encode('utf-8').isin(['']))]
