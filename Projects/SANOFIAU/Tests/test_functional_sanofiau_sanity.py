...
from Projects.SANOFIAU.Tests.Data.data_test_sanofiau_sanity import ProjectsSanityData
from Projects.SANOFIAU.Calculations import SANOFIAUCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.SANOFIAU.Tests.Data.kpi_results import SANOFIAUKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["sanofiau_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_sanofiau_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'D5A9FE0B-168B-4115-AA7D-384F56BBE3A5': []}
        kpi_results = SANOFIAUKpiResults().get_kpi_results()
