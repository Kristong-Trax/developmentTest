...
from Projects.CCTHDEMO.Utils.Fetcher import CCTHDEMOQueries
from Projects.CCTHDEMO.Utils.GeneralToolBox import CCTHDEMOGENERALToolBox
from Projects.CCTHDEMO.Utils.ParseTemplates import CCTHDEMOParseTemplates as ParseTemplates, TEMPLATE_PATH

# from Projects.CCTHDEMO.Utils.Report import Report
...
class CCTHDEMOToolBox(CCTHDEMOConsts):
    LEVEL1 = 1
    LEVEL2 = 2
    LEVEL3 = 3
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = CCTHDEMOGENERALToolBox(self.data_provider, self.output)
    ...
    def get_segmentation_and_region(self):
        ...
        """
        query = CCTHDEMOQueries.get_segmentation_and_region_data(self.store_id)
        data = pd.read_sql_query(query, self.rds_conn.db).iloc[0]
        return data.segmentation, data.region

    def get_store_data(self):
        query = CCTHDEMOQueries.get_store_data(self.store_id)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = CCTHDEMOQueries.get_all_kpi_data(self.RED_SCORE)
    ...
    def get_kpi_set_fk(self, kpi_name):
        ...
        The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
        """
        query = CCTHDEMOQueries.get_kpi_fk(kpi_name)
        kpi_static_data = pd.read_sql_query(query, self.rds_conn.db)
        return kpi_static_data
    ...
    def commit_results_data(self):
        ...
        delete_queries = CCTHDEMOQueries.get_delete_session_results_query(self.session_uid, self.session_fk)
