...
from Projects.CCTHDEMO.Utils.PositionGraph import CCTHDEMOPositionGraphs

__author__ = 'Nimrod'


class CCTHDEMOGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCTHDEMOPositionGraphs(self.data_provider)
