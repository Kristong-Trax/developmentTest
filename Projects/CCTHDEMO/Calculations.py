...
from Projects.CCTHDEMO.KPIGenerator import CCTHDEMOGenerator

__author__ = 'Nimrod'


class CCTHDEMOCalculations(BaseCalculationsScript):
    def run_project_calculations(self):
        self.timer.start()
        CCTHDEMOGenerator(self.data_provider, self.output).main_function()
...
#     Config.init()
#     project_name = 'ccthdemo'
#     data_provider = KEngineDataProvider(project_name)
#     # TT
#     sessions = \
#         ['a7bc4267-2834-4b3d-b92e-4e8185a4ff24'
#         # TT
#             # food shop
...
#         output = Output()
#         CCTHDEMOCalculations(data_provider, output).run_project_calculations()
