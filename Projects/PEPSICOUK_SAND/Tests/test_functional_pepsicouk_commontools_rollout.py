...
from Projects.PEPSICOUK.Tests.data_test_unit_pepsicouk_rollout import DataTestUnitPEPSICOUK
...
class Test_PEPSICOUKCommon(TestFunctionalCase):
    ...
    def import_path(self):
        return 'Projects.PEPSICOUK.Utils.CommonToolBoxRollout'
    ...
    def test_excluded_matches_are_not_present_in_filtered_matches_and_included_are_present(self):
        self.mock_scene_item_facts(pd.read_excel(DataTestUnitPEPSICOUK.test_case_rollout, sheetname='scif'))
        self.mock_match_product_in_scene(pd.read_excel(DataTestUnitPEPSICOUK.test_case_rollout, sheetname='matches'))
        self.mock_store_area(DataTestUnitPEPSICOUK.store_area_map_neutral)
        tool_box = PEPSICOUKCommonToolBox(self.data_provider_mock, self.output)
    ...
    def test_set_filtered_scif_and_matches_for_specific_kpi_additionally_filter_scif_and_matches(self):
        ...
        excluded_matches_expected = [11, 12, 13, 20, 29, 30, 31, 32, 44, 45, 46, 47, 48, 49, 50, 51]
