...
from Projects.DIAGEOKE.Utils.GeneralToolBox import DIAGEOKEGENERALToolBox
...
class DIAGEOKEDIAGEOToolBox:
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOKEGENERALToolBox(data_provider, output, self.kpi_static_data,
