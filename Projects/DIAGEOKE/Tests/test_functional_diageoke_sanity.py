...
from Projects.DIAGEOKE.Tests.Data.data_test_diageoke_sanity import ProjectsSanityData
from Projects.DIAGEOKE.Calculations import DIAGEOKECalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.DIAGEOKE.Tests.Data.kpi_results import DIAGEOKEKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["diageoke_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_diageoke_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'a5e20fe2-6436-421f-a700-f175c051a489': []}
        kpi_results = DIAGEOKEKpiResults().get_kpi_results()
