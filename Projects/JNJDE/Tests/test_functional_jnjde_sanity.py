...
from Projects.JNJDE.Tests.Data.data_test_jnjde_sanity import ProjectsSanityData
from Projects.JNJDE.Calculations import JNJDECalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.JNJDE.Tests.Data.kpi_results import JNJDEKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["jnjde_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_jnjde_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'16e572b3-bd8a-457f-9e55-153dbe18e406': []}
