...
from Projects.JNJES_SAND.Utils.KPIToolBox import JNJESToolBox, log_runtime

__author__ = 'nissand'


class JNJESGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = JNJESToolBox(self.data_provider, self.output)
