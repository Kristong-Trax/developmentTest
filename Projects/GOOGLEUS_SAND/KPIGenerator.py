...
from Projects.GOOGLEUS_SAND.Utils.KPIToolBox import GOOGLEUS_SANDToolBox, log_runtime

__author__ = 'Ortal'


class GOOGLEUS_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = GOOGLEUS_SANDToolBox(self.data_provider, self.output)
