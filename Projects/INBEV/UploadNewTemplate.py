...
class NewTemplate:
    ...
    def handle_updated_template(self, set_name, template_path, ignore_missings=False, replace_existing=False):
        ...
        #     self.kpi_name_field = Consts.PRODUCT_NAME
...
#     for project_name in ['inbevnl']:
#         Log.init('{} New Template'.format(project_name))
...
#         for set_name in ['must_have_assortment']:
#             file_path = '/home/uri/Documents/inbevnl/{}.xlsx'.format(set_name)
