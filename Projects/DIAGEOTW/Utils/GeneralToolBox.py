...
from Projects.DIAGEOTW.Utils.PositionGraph import DIAGEOTWPositionGraphs

__author__ = 'Nimrod'


class DIAGEOTWGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOTWPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOTWGENERALToolBox.INCLUDE_FILTER)
