...
from Projects.DIAGEOTW.Utils.GeneralToolBox import DIAGEOTWGENERALToolBox
...
class DIAGEOTWDIAGEOConsts(object):
...
class DIAGEOTWDIAGEOToolBox(DIAGEOTWDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOTWGENERALToolBox(data_provider, output, **data)
