...
from Projects.DIAGEOUK_SAND.Utils.KPIToolBox import DIAGEOUK_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOUK_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOUK_SANDToolBox(self.data_provider, self.output)
