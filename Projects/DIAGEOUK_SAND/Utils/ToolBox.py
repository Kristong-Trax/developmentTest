...
from Projects.DIAGEOUK_SAND.Utils.GeneralToolBox import DIAGEOUK_SANDGENERALToolBox
...
class DIAGEOUK_SANDDIAGEOConsts(object):
    ...
    PRODUCT = 'Product'
    BRAND = 'Brand'
    TESTED_NEW = 'Tested Product ID'
    ANCHOR_NEW = 'Anchor Product ID'
    ...
    KPI_SETS = ['MPA', 'New Products', 'POSM', 'Secondary', 'Relative Position', 'Brand Blocking',
                ...
                'Local MPA']
    AVAILABILITY_SETS = ['MPA', 'New Products', 'POSM']
    KPI_SETS_WITH_PERCENT_AS_SCORE = AVAILABILITY_SETS + ['Visible to Customer', 'Relative Position', 'Brand Blocking']
    KPI_SETS_WITHOUT_A_TEMPLATE = ['Secondary', 'Visible to Customer', 'Secondary Displays',
                                   'Brand Blocking', 'Activation Standard', 'Survey Questions', 'Brand Pouring']
    TEMPLATES_PATH = 'Diageo_templates/'
    KPI_NAME = KPI_NAME


class DIAGEOUK_SANDDIAGEOToolBox(DIAGEOUK_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOUK_SANDGENERALToolBox(data_provider, output, **data)
