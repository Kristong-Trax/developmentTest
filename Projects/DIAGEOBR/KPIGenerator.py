...
from Projects.DIAGEOBR.Utils.KPIToolBox import DIAGEOBRToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOBRGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOBRToolBox(self.data_provider, self.output)
