...
from Projects.DIAGEOBR.Utils.PositionGraph import DIAGEOBRPositionGraphs

__author__ = 'Nimrod'


class DIAGEOBRGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOBRPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOBRGENERALToolBox.INCLUDE_FILTER)
