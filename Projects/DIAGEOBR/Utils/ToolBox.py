...
from Projects.DIAGEOBR.Utils.GeneralToolBox import DIAGEOBRGENERALToolBox
...
class DIAGEOBRDIAGEOConsts(object):
...
class DIAGEOBRDIAGEOToolBox(DIAGEOBRDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOBRGENERALToolBox(data_provider, output, **data)
