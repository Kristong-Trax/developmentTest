...
from Projects.DIAGEONORDICS.Utils.GeneralToolBox import DIAGEONORDICSGENERALToolBox
...
class DIAGEONORDICSDIAGEOConsts(object):
...
class DIAGEONORDICSDIAGEOToolBox(DIAGEONORDICSDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEONORDICSGENERALToolBox(data_provider, output, **data)
