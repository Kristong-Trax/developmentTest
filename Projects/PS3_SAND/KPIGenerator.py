...
from Projects.PS3_SAND.Utils.KPIToolBox import PS3_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class PS3_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PS3_SANDToolBox(self.data_provider, self.output)
