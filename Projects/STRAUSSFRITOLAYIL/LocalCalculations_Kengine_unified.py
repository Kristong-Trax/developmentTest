...
if __name__ == '__main__':
    ...
    sessions = [
                {"session_uid": '521f7b7e-6f2d-40e2-8a01-514f0f21d7b2', "session_id": 60395},
                {"session_uid": '085ab88e-e7f5-4302-b864-46b31e5d4836', "session_id": 60390},
    ...
    for session in sessions:
        try:
            ...
            message_session = {'event_name': 'SESSION_PROCESSED', 'timestamp': '', 'project_name': project_name,
                               ...
                               'number_of_scenes': 1, 'attributes': {'ApproximateReceiveCount': 1},
                               'wave_type': 'primary', 'wave_uid': ''}
