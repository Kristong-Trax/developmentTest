...
class NumberOfUniqueBrandsBrandKpi(UnifiedCalculationsScript):
    ...
    def calculate(self):
        sku_kpi_fk = self.utils.common.get_kpi_fk_by_kpi_type(Consts.NUMBER_OF_UNQIUE_BRANDS_BRAND_KPI)
        ...
        for i, sku_row in own_manufacturer_skus.iterrows():
            ...
            self.write_to_db_result(fk=sku_kpi_fk, numerator_id=product_fk, result=result,
