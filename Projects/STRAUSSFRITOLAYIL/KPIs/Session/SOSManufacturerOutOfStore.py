...
class SOSManufacturerOutOfStoreKpi(UnifiedCalculationsScript):

    def __init__(self, data_provider, config_params=None, **kwargs):
        super(SOSManufacturerOutOfStoreKpi, self).__init__(data_provider, config_params=config_params, **kwargs)
