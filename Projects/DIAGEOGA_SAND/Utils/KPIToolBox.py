...
from Projects.DIAGEOGA_SAND.Utils.Fetcher import DIAGEOGAQueries
from Projects.DIAGEOGA_SAND.Utils.ToolBox import DIAGEOToolBox
...
class DIAGEOGAToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOGAQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOGAQueries.get_delete_session_results_query(self.session_uid)
