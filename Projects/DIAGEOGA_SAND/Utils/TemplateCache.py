...
from Projects.DIAGEOGA_SAND.Utils.GeneralToolBox import DIAGEOGAGENERALToolBox
from Projects.DIAGEOGA_SAND.Utils.ParseTemplates import parse_template
...
class DIAGEOGATemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOGAGENERALToolBox.get_json_data(file_path)
        else:
