...
from Projects.PENAFLORAR_SAND.Utils.KPIToolBox import PENAFLORAR_SANDDIAGEOARToolBox, log_runtime

__author__ = 'Yasmin'


class PENAFLORAR_SANDDIAGEOARGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PENAFLORAR_SANDDIAGEOARToolBox(self.data_provider, self.output)
