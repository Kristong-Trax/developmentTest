...
from Projects.PENAFLORAR_SAND.Utils.ParseTemplates import parse_template
...
class PENAFLORAR_SANDDIAGEOARTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = PENAFLORAR_SANDDIAGEOARGENERALToolBox.get_json_data(file_path)
        else:
