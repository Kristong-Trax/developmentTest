...
class PENAFLORAR_SANDDIAGEOConsts(object):
...
class PENAFLORAR_SANDDIAGEOToolBox(PENAFLORAR_SANDDIAGEOConsts):
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOAUPENAFLORAR_SANDDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOAUPENAFLORAR_SANDDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOAUPENAFLORAR_SANDDIAGEOToolBox.DIAGEO
