...
from Projects.CUBAU_SAND.Utils.PositionGraph import CUBAUPositionGraphs

__author__ = 'Nimrod'


class CUBAUGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CUBAUPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    #                    INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUCUBAUGENERALToolBox.INCLUDE_FILTER)
