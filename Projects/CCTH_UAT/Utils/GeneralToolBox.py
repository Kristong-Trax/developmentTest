...
from Projects.CCTH_UAT.Utils.PositionGraph import CCTH_UATPositionGraphs

__author__ = 'Nimrod'


class CCTH_UATGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCTH_UATPositionGraphs(self.data_provider)
