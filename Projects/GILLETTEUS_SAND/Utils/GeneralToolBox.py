...
from Projects.GILLETTEUS_SAND.Utils.PositionGraph import GILLETTEUS_SANDPositionGraphs

__author__ = 'Nimrod'


class GILLETTEUS_SANDGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = GILLETTEUS_SANDPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUGILLETTEUS_SANDGENERALToolBox.INCLUDE_FILTER)
