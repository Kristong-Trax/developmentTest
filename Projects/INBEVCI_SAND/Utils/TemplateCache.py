...
from Projects.INBEVCI_SAND.Utils.GeneralToolBox import INBEVCIGENERALToolBox
...
class INBEVCITemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = INBEVCIGENERALToolBox.get_json_data(file_path)
        else:
