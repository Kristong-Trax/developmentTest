...
from Projects.INBEVCI_SAND.Utils.KPIToolBox import INBEVCIToolBox, log_runtime
...
class INBEVCIGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVCIToolBox(self.data_provider, self.output)
