...
from Trax.Data.Testing.Resources import BaseSeedData, DATA_TYPE, FILES_RELATIVE_PATH, DATABASE_NAME, COLLECTION_NAME, DATA
...
class ProjectsSanityData(BaseSeedData):
    ...
    pngjp_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                  FILES_RELATIVE_PATH: ['Data/pngjp_seed.sql.gz'],
