...
from Projects.SANOFICM.Tests.Data.data_test_sanoficm_sanity import ProjectsSanityData
from Projects.SANOFICM.Calculations import SANOFICMCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.SANOFICM.Tests.Data.kpi_results import SANOFICMKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["sanoficm_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
