...
from Projects.DIAGEOMX.Utils.PositionGraph import DIAGEOMXPositionGraphs

__author__ = 'Nimrod'


class DIAGEOMXGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOMXPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
