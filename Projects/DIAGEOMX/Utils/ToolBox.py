...
from Projects.DIAGEOMX.Utils.GeneralToolBox import DIAGEOMXGENERALToolBox
...
class DIAGEOMXDIAGEOConsts(object):
...
class DIAGEOMXDIAGEOToolBox(DIAGEOMXDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOMXGENERALToolBox(data_provider, output, **data)
