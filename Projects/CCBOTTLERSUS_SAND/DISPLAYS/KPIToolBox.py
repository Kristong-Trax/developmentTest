...
from Projects.CCBOTTLERSUS_SAND.DISPLAYS.Fetcher import CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries
...
class DISPLAYSCCBOTTLERSUS_SANDConsts(object):
...
class CCBOTTLERSUS_SANDDISPLAYSToolBox(DISPLAYSCCBOTTLERSUS_SANDConsts):
    ...
    #     query = CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries.get_attributes_data()
    ...
    def get_match_display(self):
        ...
        """
        query = CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries.get_match_display(self.session_uid)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries.get_all_kpi_data()
    ...
    def commit_results_data(self, kpi_set_fk):
        ...
        if kpi_set_fk is not None:
            query = CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries.get_atomic_pk_to_delete(self.session_uid, kpi_set_fk)
        ...
        if kpi_pks and atomic_pks:
            delete_queries = CCBOTTLERSUS_SANDDISPLAYSCCBOTTLERSUS_SANDQueries.get_delete_session_results_query(self.session_uid, kpi_set_fk, kpi_pks,
                                                                          atomic_pks)
