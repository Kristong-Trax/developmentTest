...
from Projects.CCBOTTLERSUS_SAND.DISPLAYS.PositionGraph import DISPLAYSPositionGraphs
...
class DISPLAYSGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DISPLAYSPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
