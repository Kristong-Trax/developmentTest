...
from Projects.CCBOTTLERSUS_SAND.Utils.GeneralToolBox import CCBOTTLERSUSGENERALToolBox
...
class CCBOTTLERSUS_SANDTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = CCBOTTLERSUSGENERALToolBox.get_json_data(file_path)
        else:
