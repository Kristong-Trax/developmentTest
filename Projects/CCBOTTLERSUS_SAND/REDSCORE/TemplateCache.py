...
from Projects.RED_SCORE.Utils.GeneralToolBox import REDGENERALToolBox
from Projects.RED_SCORE.Utils.ParseTemplates import parse_template
...
class CCBOTTLERSUS_SANDREDTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = CCBOTTLERSUS_SANDREDGENERALToolBox.get_json_data(file_path)
        else:
