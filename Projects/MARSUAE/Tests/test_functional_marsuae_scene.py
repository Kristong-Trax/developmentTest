...
class TestMarsuaeScene(TestFunctionalCase):
    # seeder = Seeder()

    @property
    def import_path(self):
        return 'Projects.MARSUAE.Utils.KPISceneToolBox'

    def set_up(self):
        super(TestMarsuaeScene, self).set_up()
    ...
    def test_calculate_price_generates_no_kpi_results_if_no_prices_in_scene(self):
        ...
        scene_tb = MARSUAESceneToolBox(self.data_provider_mock, self.output)
