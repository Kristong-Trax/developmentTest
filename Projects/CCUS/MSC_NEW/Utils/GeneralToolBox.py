...
from Projects.CCUS.MSC_NEW.Utils.PositionGraph import MSC_NEWPositionGraphs
...
class MSC_NEWGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = MSC_NEWPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
