...
import pandas as pd
from Projects.CCUS.MSC_NEW.Utils.GeneralToolBox import NEW_OBBOGENERALToolBox
...
class MSC_NEWemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = NEW_OBBOGENERALToolBox.get_json_data(file_path)
        else:
