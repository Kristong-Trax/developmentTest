...
from Projects.CCUS.Programs.Utils.PositionGraph import NEW_OBBOPositionGraphs
...
class NEW_OBBOGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = NEW_OBBOPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
