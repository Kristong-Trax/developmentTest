...
from Projects.CCUS.Holiday.Utils.PositionGraph import HolidayPositionGraphs

__author__ = 'Ortal'


class HolidayGENERALToolBox:
    ...
    def get_atts(self):
        ...
        query = HolidayQueries.get_product_atts()
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = HolidayPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
