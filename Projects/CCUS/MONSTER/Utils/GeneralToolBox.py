...
from Projects.CCUS.MONSTER.Utils.PositionGraph import MONSTERPositionGraphs
...
class MONSTERGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = MONSTERPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
