...
from Projects.INBEVBE.Utils.PositionGraph import INBEVBEINBEVBEPositionGraphs
from Projects.INBEVBE.Utils.GeneralToolBox import INBEVBEINBEVBEGENERALToolBox
...
class INBEVBEINBEVBEINBEVToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    EXCLUDE_EMPTY = 0
    INCLUDE_EMPTY = 1
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = INBEVBEINBEVBEGENERALToolBox(data_provider, output,
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVBEINBEVBEPositionGraphs(self.data_provider)
