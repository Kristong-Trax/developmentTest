...
from Projects.INBEVBE.Utils.KPIToolBox import INBEVBEINBEVBEToolBox

__author__ = 'urid'


class INBEVBEINBEVBEGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVBEINBEVBEToolBox(self.data_provider, self.output)
    ...
    def main_function(self):
        ...
        set_names = ['Product Blocking', 'Linear Share of Shelf', 'OSA',
                     'Pallet Presence', 'Share of Assortment']
