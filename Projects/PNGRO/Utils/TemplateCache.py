...
from Projects.PNGRO.Utils.GeneralToolBox import PNGRO_PRODPNGROGENERALToolBox
...
class PNGRO_PRODTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = PNGRO_PRODPNGROGENERALToolBox.get_json_data(file_path)
        else:
