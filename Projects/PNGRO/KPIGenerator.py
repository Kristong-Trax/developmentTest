...
from Projects.PNGRO.Utils.KPIToolBox import PNGRO_PRODToolBox, log_runtime

__author__ = 'Israel'


class PNGRO_PRODGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PNGRO_PRODToolBox(self.data_provider, self.output)
