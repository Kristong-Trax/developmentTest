...
from Projects.DUNKIN_SAND.Utils.GeneralToolBox import DUNKINDONATSGENERALToolBox
...
class DUNKINToolBox:
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DUNKINDONATSGENERALToolBox(data_provider, output, self.kpi_static_data, geometric_kpi_flag=True)
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DUNKINPositionGraphs(self.data_provider)
    ...
    def calculate_products_on_bay_edge(self, min_number_of_facings=1, min_number_of_shelves=1,
        ...
        """
        return self.general_tools.calculate_products_on_bay_edge(min_number_of_facings, min_number_of_shelves, position,
                                                                 **filters)
    ...
    def calculate_share_of_shelf(self, manufacturer='CCNA', sos_filters=None, include_empty=EXCLUDE_EMPTY,
                                 **general_filters):
        """
