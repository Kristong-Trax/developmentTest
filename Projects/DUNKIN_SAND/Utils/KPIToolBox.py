...
from Projects.DUNKIN_SAND.Utils.ToolBox import DUNKINToolBox
...
class DUNKINKPIToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DUNKINToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
        """
        query = DUNKINQueries.get_all_kpi_data()
    ...
    def get_atts(self):
        ...
        The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
        """
        query = DUNKINQueries.get_product_atts()
        product_att4 = pd.read_sql_query(query, self.rds_conn.db)
    ...
    def get_match_display(self):
        ...
        """
        query = DUNKINQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self, set_fk=None ):
        """
        This function writes all KPI results to the DB, and commits the changes.
        """
        delete_queries = DUNKINQueries.get_delete_session_results_query(self.session_uid,set_fk)
        cur = self.rds_conn.db.cursor()
