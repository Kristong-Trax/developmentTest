...
from Projects.INBEVLU_SAND.Utils.PositionGraph import INBEVLU_SANDINBEVBEPositionGraphs
from Projects.INBEVLU_SAND.Utils.GeneralToolBox import INBEVLU_SANDINBEVBEGENERALToolBox
...
class INBEVLU_SANDINBEVBEINBEVToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    EXCLUDE_EMPTY = 0
    INCLUDE_EMPTY = 1
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = INBEVLU_SANDINBEVBEGENERALToolBox(data_provider, output,
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVLU_SANDINBEVBEPositionGraphs(self.data_provider)
