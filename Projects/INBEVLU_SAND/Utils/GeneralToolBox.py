...
class INBEVLU_SANDINBEVBEGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVLU_SANDINBEVBEPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def calculate_share_space_length(self, **filters):
        ...
        space_length = filtered_matches['width_mm'].sum()
        return space_length
