...
from Projects.INBEVLU_SAND.Utils.KPIToolBox import INBEVLU_SANDINBEVBEToolBox

__author__ = 'urid'


class INBEVLU_SANDINBEVBEGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVLU_SANDINBEVBEToolBox(self.data_provider, self.output)
