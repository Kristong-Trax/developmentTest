...
from Projects.INBEVBR_SAND.Utils.KPIToolBox import INBEVBR_SANDToolBox, log_runtime

__author__ = 'Yasmin'

class INBEVBR_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVBR_SANDToolBox(self.data_provider, self.output)
    ...
    def main_function(self):
        ...
        kpi_template = parse_template(self.tool_box.template_path, sheet_name='KPIs')
