...
class Const(object):
    ...
    DELETE_FIELDS = [KPI_ID, REGION_TEMPLATE, ENGLISH_KPI_NAME, COUNT_TYPE, TARGET, EXPECTED_RESULT, TARGET_OPERATOR,
                     MEASUREMENT_UNIT,PRODUCT,PRODUCT_SIZE,ATT1, STORE_TYPE_TEMPLATE, WEIGHT, STATE_TEMPLATE,
                     SECONDARY_TARGET, GROUP_KPI_NAME,SCORE,BEER_TYPE, CONTAINER_TYPE, FLAVOUR]
