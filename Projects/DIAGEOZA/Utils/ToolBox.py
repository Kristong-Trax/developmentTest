...
from Projects.DIAGEOZA.Utils.GeneralToolBox import DIAGEOZAGENERALToolBox
...
class DIAGEOZADIAGEOConsts(object):
...
class DIAGEOZADIAGEOToolBox(DIAGEOZADIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOZAGENERALToolBox(data_provider, output, **data)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOZADIAGEOToolBox.DIAGEO,
                                                                 DIAGEOZADIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOZADIAGEOToolBox.DIAGEO
