...
from Projects.DIAGEOZA.Utils.Fetcher import DIAGEOZAQueries
from Projects.DIAGEOZA.Utils.ToolBox import DIAGEOZADIAGEOToolBox
...
class DIAGEOZAToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOZADIAGEOToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOZAQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOZAQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOZAQueries.get_delete_session_results_query(self.session_uid)
