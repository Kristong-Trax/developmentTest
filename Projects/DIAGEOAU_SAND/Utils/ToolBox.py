...
from Projects.DIAGEOAU_SAND.Utils.GeneralToolBox import DIAGEOAU_SANDGENERALToolBox
...
class DIAGEOAU_SANDDIAGEOConsts(object):
...
class DIAGEOAU_SANDDIAGEOToolBox(DIAGEOAU_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOAU_SANDGENERALToolBox(data_provider, output, **data)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOAU_SANDDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOAU_SANDDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOAU_SANDDIAGEOToolBox.DIAGEO
