...
class DIAGEOAU_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOAU_SANDDIAGEOToolBox(self.data_provider, output,
    ...
    def get_business_unit(self):
        ...
        """
        query = DIAGEOAU_SANDQueries.get_business_unit_data(self.store_info['store_fk'].values[0])
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOAU_SANDQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOAU_SANDQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOAU_SANDQueries.get_delete_session_results_query(self.session_uid)
