...
from Projects.DIAGEOAU_SAND.Utils.PositionGraph import DIAGEOAU_SANDPositionGraphs

__author__ = 'Nimrod'


class DIAGEOAU_SANDGENERALToolBox:
    ...
    def __init__(self, data_provider, output, rds_conn=None, **kwargs):
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOAU_SANDPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAU_SANDGENERALToolBox.INCLUDE_FILTER)
