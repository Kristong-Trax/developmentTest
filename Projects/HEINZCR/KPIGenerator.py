...
from Projects.HEINZCR.Utils.KPIToolBox import HEINZCRHEINZCRToolBox, log_runtime

__author__ = 'Eli'


class HEINZCRHEINZCRGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = HEINZCRHEINZCRToolBox(self.data_provider, self.output)
