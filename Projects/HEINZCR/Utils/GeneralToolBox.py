...
from Projects.HEINZCR.Utils.PositionGraph import HEINZCRHEINZCRPositionGraphs as PositionGraphs

__author__ = 'Nimrod'


class HEINZCRHEINZCRGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUHEINZCRHEINZCRGENERALToolBox.INCLUDE_FILTER)
