...
from Projects.INBEVBE_SAND.Utils.KPIToolBox import INBEVBE_SANDToolBox, log_runtime

__author__ = 'urid'


class INBEVBE_SANDGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVBE_SANDToolBox(self.data_provider, self.output)
