...
class Consts(object):
    ...
    GROUP_COLS_TO_KEEP = [Agc.ASSORTMENT_GROUP_FK, 'kpi_fk_lvl2', Sc.FACINGS, DISPLAY_FK, Src.RESULT, Sc.MANUFACTURER_FK]
    ...
    SOS_ALL_BRAND_LVL = 3
    SOS_ALL_MANU_LVL = 2
    LINEAR_LEN_ATTR = 'net_len_ign_stack'
    TOTAL_LINEAR_SOS = 'total_linear_sos'
    ...
    BRAND_SOS_RENAME_DICT = {Sc.BRAND_FK: Src.NUMERATOR_ID, Sc.MANUFACTURER_FK: Src.DENOMINATOR_ID,
                             Sc.CATEGORY_FK: Src.CONTEXT_ID, LINEAR_LEN_ATTR: Src.NUMERATOR_RESULT,
                             TOTAL_LINEAR_SOS: Src.DENOMINATOR_RESULT}
    ALL_MANU_SOS_RENAME_DICT = {Sc.MANUFACTURER_FK: Src.NUMERATOR_ID, Sc.CATEGORY_FK: Src.DENOMINATOR_ID,
                                LINEAR_LEN_ATTR: Src.NUMERATOR_RESULT, TOTAL_LINEAR_SOS: Src.DENOMINATOR_RESULT}
