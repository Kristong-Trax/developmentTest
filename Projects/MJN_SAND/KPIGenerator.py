...
from Projects.MJN_SAND.Utils.KPIToolBox import MJNCN_SANDToolBox, log_runtime

__author__ = 'Yasmin'


class MJNCN_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = MJNCN_SANDToolBox(self.data_provider, self.output)
