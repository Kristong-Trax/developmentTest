...
from Projects.DIAGEORU.Utils.PositionGraph import DIAGEORUPositionGraphs
...
class DIAGEORUGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEORUPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
