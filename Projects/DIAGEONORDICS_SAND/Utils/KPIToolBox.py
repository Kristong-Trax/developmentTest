...
from Projects.DIAGEONORDICS_SAND.Utils.Fetcher import DIAGEONORDICS_SANDQueries
from Projects.DIAGEONORDICS_SAND.Utils.ToolBox import DIAGEONORDICS_SANDDIAGEOToolBox
...
class DIAGEONORDICS_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEONORDICS_SANDDIAGEOToolBox(self.data_provider, output, kpi_static_data=self.kpi_static_data,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEONORDICS_SANDQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEONORDICS_SANDQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEONORDICS_SANDQueries.get_delete_session_results_query(self.session_uid)
