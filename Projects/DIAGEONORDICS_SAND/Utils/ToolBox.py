...
from Projects.DIAGEONORDICS_SAND.Utils.GeneralToolBox import DIAGEONORDICS_SANDGENERALToolBox
...
class DIAGEONORDICS_SANDDIAGEOConsts(object):
...
class DIAGEONORDICS_SANDDIAGEOToolBox(DIAGEONORDICS_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEONORDICS_SANDGENERALToolBox(data_provider, output, **data)
