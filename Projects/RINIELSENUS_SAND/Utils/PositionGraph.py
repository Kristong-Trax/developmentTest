...
class MarsUsPositionGraphs:
    ...
    def get_filtered_matches(self):
        ...
        scene_template = scene_template.merge(self.data_provider.project_templates[['template_name',
    ...
    def get_surrounding_products(self, anchor, matches):
        ...
        if anchor_facing < anchor_shelf_items:
            ...
            if right_bay.empty:
                ...
                if self.proximity_mode == self.STRICT_MODE:
                    surrounding_right = right_bay[
                        (right_bay[self.TOP] < anchor_y) & (right_bay[self.BOTTOM] > anchor_y)]
                else:
