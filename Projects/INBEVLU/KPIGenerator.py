...
from Projects.INBEVLU.Utils.KPIToolBox import INBEVLUINBEVBEToolBox

__author__ = 'urid'


class INBEVLUINBEVBEGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVLUINBEVBEToolBox(self.data_provider, self.output)
