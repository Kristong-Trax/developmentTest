...
from Projects.INBEVLU.Utils.PositionGraph import INBEVLUINBEVBEPositionGraphs
from Projects.INBEVLU.Utils.GeneralToolBox import INBEVLUINBEVBEGENERALToolBox
...
class INBEVLUINBEVBEINBEVToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    EXCLUDE_EMPTY = 0
    INCLUDE_EMPTY = 1
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = INBEVLUINBEVBEGENERALToolBox(data_provider, output,
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVLUINBEVBEPositionGraphs(self.data_provider)
