...
from Projects.PNGAU.Utils.PositionGraph import PNGAUPositionGraphs

__author__ = 'Nimrod'


class PNGAUGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = PNGAUPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUPNGAUGENERALToolBox.INCLUDE_FILTER)
