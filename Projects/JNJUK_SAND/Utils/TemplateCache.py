...
from Projects.JNJUK_SAND.Utils.GeneralToolBox import JNJUKGENERALToolBox
from Projects.JNJUK_SAND.Utils.ParseTemplates import parse_template
...
class JNJUKTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = JNJUKGENERALToolBox.get_json_data(file_path)
        else:
