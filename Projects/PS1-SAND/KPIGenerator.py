...
from Projects.DIAGEOIE.Utils.KPIToolBox import DIAGEOIEToolBox, log_runtime

__author__ = 'Yasmin'


class DIAGEOIEGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOIEToolBox(self.data_provider, self.output)
