...
from Projects.INTEG21.Utils.Const import DOG_MAIN_MEAL_WET
from Projects.INTEG21.Utils.Utils import strip_df
...
class ParseMarsUsTemplates(object):
    ...
    def _get_template_path(set_name, i):
        template_name = 'Template_2019 SPT Year End_v1.2' if i == 0 else 'Template_2019_Test Meijer_BDB YE_v2'
