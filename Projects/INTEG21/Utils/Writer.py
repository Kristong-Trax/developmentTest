...
from Projects.INTEG21.Exceptions import AtomicKpiNotInStaticException, KpiNotInStaticException, \
    KpiSetNotInStaticException
from Projects.INTEG21.Utils.Fetcher import MarsUsQueries
from Projects.INTEG21.Utils.Utils import log_runtime, get_all_kpi_static_data
...
class KpiResultsWriterExcel(KpiResultsWriter):
    def __init__(self, session_uid, store_id, visit_date, project_name=None):
        ...
        self.path = '/home/{}/{}_results/'.format(os.getenv('USERNAME'), 'INTEG21')
