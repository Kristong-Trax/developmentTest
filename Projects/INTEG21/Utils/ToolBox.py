...
from Projects.INTEG21.Utils.PositionGraph import INTEG21INBEVBEPositionGraphs
from Projects.INTEG21.Utils.GeneralToolBox import INTEG21INBEVBEGENERALToolBox
...
class INTEG21INBEVBEINBEVToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    EXCLUDE_EMPTY = 0
    INCLUDE_EMPTY = 1
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = INTEG21INBEVBEGENERALToolBox(data_provider, output,
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INTEG21INBEVBEPositionGraphs(self.data_provider)
