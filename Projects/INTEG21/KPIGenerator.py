...
from Projects.INTEG21.Utils.KPIToolBox import INTEG21INBEVBEToolBox

__author__ = 'urid'


class INTEG21INBEVBEGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INTEG21INBEVBEToolBox(self.data_provider, self.output)
