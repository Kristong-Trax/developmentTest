...
# from KPIUtils_v2.Utils.INTEG21Consts.OldDB import KpiResults
# from Projects.INTEG21.Utils.KpiQualitative import INTEG21KpiQualitative_ToolBox
# from Trax.Utils.Testing.Case import TestCase
#
# import pandas as pd
# import Projects.INTEG21.Tests.test_data as Data
#
# __author__ = 'israels'
#
#
...
#
#     @mock.patch('Projects.INTEG21.Utils.KpiQualitative.ProjectConnector')
#     def setUp(self, x):
#         self.data_provider_mock = MagicMock()
#         self.data_provider_mock.project_name = 'integ21'
...
#         self.data = Data
#         self.tool_box = INTEG21KpiQualitative_ToolBox(self.data_provider_mock, self.output)
