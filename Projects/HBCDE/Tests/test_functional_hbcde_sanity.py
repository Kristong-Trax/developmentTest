...
from Projects.HBCDE.Tests.Data.test_data_hbcde_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["hbcde_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
