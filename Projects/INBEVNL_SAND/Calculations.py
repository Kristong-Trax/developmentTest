...
from Projects.INBEVNL_SAND.KPIGenerator import INBEVNLINBEVBEGenerator
...
class INBEVNLINBEVBECalculations(BaseCalculationsScript):
    def run_project_calculations(self):
        self.timer.start()
        TEMPLATE_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'INBEVNL_SAND',
                                     'Data', 'POCE_Template.xlsx')
