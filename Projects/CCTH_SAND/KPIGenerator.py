...
from Projects.CCTH_SAND.Utils.KPIToolBox import CCTH_SANDToolBox, log_runtime
from Projects.CCTH_SAND.SuccessfulVisits import CCTH_SANDSuccessfulSessions

__author__ = 'Nimrod'


class CCTH_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = CCTH_SANDToolBox(self.data_provider, self.output)
