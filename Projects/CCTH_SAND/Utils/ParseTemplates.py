...
class CCTH_SANDGapConsts(object):
...
class CCTH_SANDSurveyConsts(object):
...
class CCTH_SANDAvailabilityConsts(object):
...
class CCTH_SANDKPIConsts(object):
...
class CCTH_SANDParseTemplates(CCTH_SANDKPIConsts):
    ...
    def __init__(self, template):
        ...
        self.survey_consts = CCTH_SANDSurveyConsts()
        self.availability_consts = CCTH_SANDAvailabilityConsts()
        self.gap_consts = CCTH_SANDGapConsts()
