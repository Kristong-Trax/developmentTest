...
from Projects.RED_SCORE.Utils.Fetcher import REDQueries
...
class REDToolBox:
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = REDQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = REDQueries.get_delete_session_results_query(self.session_uid)
