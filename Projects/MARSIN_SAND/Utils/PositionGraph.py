...
class MARSIN_SANDPositionGraphs:
    ...
    ATTRIBUTES_TO_SAVE = ['product_name', 'product_type', 'product_ean_code', 'sub_brand_name', 'brand_name',
                          'category', 'sub_category', 'manufacturer_name', 'front_facing', 'att1']
