...
from Projects.CCTH.KPIGenerator import CCTHGenerator

__author__ = 'Nimrod'


class CCTHCalculations(BaseCalculationsScript):
    def run_project_calculations(self):
        self.timer.start()
        CCTHGenerator(self.data_provider, self.output).main_function()
