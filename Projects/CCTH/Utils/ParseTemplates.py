...
class CCTHAvailabilityConsts(object):
...
class CCTHParseTemplates(CCTHKPIConsts):
    ...
    def __init__(self, template):
        ...
        self.survey_consts = CCTHSurveyConsts()
        self.availability_consts = CCTHAvailabilityConsts()
        self.gap_consts = CCTHGapConsts()
