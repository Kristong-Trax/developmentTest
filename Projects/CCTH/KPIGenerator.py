...
from Projects.CCTH.Utils.KPIToolBox import CCTHToolBox, log_runtime
from Projects.CCTH.SuccessfulVisits import CCTHSuccessfulSessions
...
class CCTHGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = CCTHToolBox(self.data_provider, self.output)
    ...
    def main_function(self):
        ...
        if self.tool_box.store_type:
            successful = CCTHSuccessfulSessions(self.tool_box.rds_conn, self.session_uid)
