...
from Projects.DIAGEOTW_SAND.Utils.GeneralToolBox import DIAGEOTW_SANDGENERALToolBox
...
class DIAGEOTW_SANDDIAGEOConsts(object):
...
class DIAGEOTW_SANDDIAGEOToolBox(DIAGEOTW_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOTW_SANDGENERALToolBox(data_provider, output, **data)
