...
from Projects.DIAGEOTW_SAND.Utils.PositionGraph import DIAGEOTW_SANDPositionGraphs

__author__ = 'Nimrod'


class DIAGEOTW_SANDGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOTW_SANDPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOTW_SANDGENERALToolBox.INCLUDE_FILTER)
