...
from Projects.CBCIL_SAND.Utils.KPIToolBox import CBCIL_ToolBox, log_runtime

__author__ = 'Israel'


class CBCIL_PRODGenerator(object):
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = CBCIL_ToolBox(self.data_provider, self.output)
