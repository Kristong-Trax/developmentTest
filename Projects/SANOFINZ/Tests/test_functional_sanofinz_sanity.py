...
from Projects.SANOFINZ.Tests.Data.data_test_sanofinz_sanity import ProjectsSanityData
from Projects.SANOFINZ.Calculations import SANOFINZCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.SANOFINZ.Tests.Data.kpi_results import SANOFINZKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["sanofinz_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_sanofinz_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'097B89BA-57B1-429E-BC29-57C971AF1B77': []}
        kpi_results = SANOFINZKpiResults().get_kpi_results()
