...
from Projects.INBEVEC_SAND.Utils.Fetcher import INBEVEC_SANDQueries
from Projects.INBEVEC_SAND.Utils.GeneralToolBox import INBEVEC_SANDGENERALToolBox
...
class INBEVEC_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = INBEVEC_SANDGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = INBEVEC_SANDQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = INBEVEC_SANDQueries.get_delete_session_results_query(self.session_uid)
