...
from Projects.CCBR_SAND.Utils.GeneralToolBox import CCBRGENERALToolBox
from Projects.CCBR_SAND.Utils.ParseTemplates import parse_template
...
class CCBRTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = CCBRGENERALToolBox.get_json_data(file_path)
        else:
