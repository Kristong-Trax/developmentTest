...
from Projects.HEINEKENCN.Utils.GeneralToolBox import HEINEKENCNHEINEKENCNGENERALToolBox
...
class HEINEKENCNHEINEKENCNTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = HEINEKENCNHEINEKENCNGENERALToolBox.get_json_data(file_path)
        else:
