...
class BATRU_SANDGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUBATRU_SANDGENERALToolBox.INCLUDE_FILTER)
    ...
    def get_json_data(file_path, sheet_name=None, skiprows=0):
        ...
        for sheet_name in sheet_names:
            try:
                output = pd.read_excel(file_path, skiprows=skiprows, sheetname=sheet_name)
    ...
    def get_match_display(self):
        ...
        """
        query = BATRU_SANDQueries.get_match_display(self.session_uid)
