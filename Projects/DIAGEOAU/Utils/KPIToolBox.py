...
class DIAGEOAUToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOAUDIAGEOToolBox(self.data_provider, output,
    ...
    def get_business_unit(self):
        ...
        """
        query = DIAGEOAUQueries.get_business_unit_data(self.store_info['store_fk'].values[0])
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOAUQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOAUQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOAUQueries.get_delete_session_results_query(self.session_uid)
