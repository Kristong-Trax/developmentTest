...
from Projects.DIAGEOAU.Utils.PositionGraph import DIAGEOAUPositionGraphs

__author__ = 'Nimrod'


class DIAGEOAUGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOAUPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
