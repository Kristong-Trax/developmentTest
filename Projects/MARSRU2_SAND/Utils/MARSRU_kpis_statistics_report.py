...
class MARSRU2_SANDMARSRU_KPIsStatistics:
...
def run(sd=None, ed=None, to=None, pivoted=None):
    try:
        marsru_report = MARSRU2_SANDMARSRU_KPIsStatistics(sd, ed, to, pivoted)
...
if __name__ == '__main__':
    ...
    # marsru_report = MARSRU2_SANDMARSRU_KPIsStatistics()
    marsru_report = MARSRU2_SANDMARSRU_KPIsStatistics('2019-02-25', '2019-03-10', 'sergey@traxretail.com')
    marsru_report.create_report()
