...
from Projects.PNGCAREUS_SAND.Utils.PositionGraph import PNGCAREUSPositionGraphs

__author__ = 'Nimrod'


class PNGCAREUSGENERALToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    CONTAIN_FILTER = 2
    EXCLUDE_EMPTY = False
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = PNGCAREUSPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def calculate_flexible_blocks(self, number_of_allowed_others=3, **filters):
        """
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUPNGCAREUSGENERALToolBox.INCLUDE_FILTER)
