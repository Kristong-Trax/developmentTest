...
from Projects.DIAGEOPT.Utils.GeneralToolBox import DIAGEOPTGENERALToolBox
...
class DIAGEOPTDIAGEOConsts(object):
    ...
    KPI_SETS = ['MPA products availability', 'New Products Availability', 'MPA', 'Local MPA', 'New Products', 'POSM',
                'Secondary Displays', 'Relative Position', 'Brand Blocking',
...
class DIAGEOPTDIAGEOToolBox(DIAGEOPTDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOPTGENERALToolBox(data_provider, output, **data)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOPTDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOPTDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOPTDIAGEOToolBox.DIAGEO
