...
from Projects.PSAPAC_SAND3.Utils.KPISceneToolBox import PsApacGSKAUSceneToolBox
...
class SceneGenerator:
    ...
    def __init__(self, data_provider, output=None):
        ...
        self.scene_tool_box = PsApacGSKAUSceneToolBox(self.data_provider, self.output, self.common)
    ...
    def scene_main_calculation(self):
        ...
        if self.scene_tool_box.match_product_in_scene.empty:
            ...
            self.scene_tool_box.calculate_layout_compliance()
