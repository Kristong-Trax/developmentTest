...
from Projects.CCZA.Utils.PositionGraph import CCZAPositionGraphs
...
class CCZAGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUCCZACCZAGENERALToolBox.INCLUDE_FILTER)
