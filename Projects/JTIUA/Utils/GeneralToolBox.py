...
from Projects.JTIUA.Utils.PositionGraph import JTIUAPositionGraphs

__author__ = 'Nimrod'


class JTIUAGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = JTIUAPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
