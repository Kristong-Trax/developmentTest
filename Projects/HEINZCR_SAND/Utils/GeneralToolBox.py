...
from Projects.HEINZCR_SAND.Utils.PositionGraph import HEINZCRPositionGraphs as PositionGraphs

__author__ = 'Nimrod'


class HEINZCRGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUHEINZCRGENERALToolBox.INCLUDE_FILTER)
