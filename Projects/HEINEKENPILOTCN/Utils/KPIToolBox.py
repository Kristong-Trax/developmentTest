...
from Projects.HEINEKENPILOTCN.Utils.ParseTemplates import parse_template
import os
from Projects.HEINEKENPILOTCN.Utils.Fetcher import HEINEKENPILOTCNQueries
from Projects.HEINEKENPILOTCN.Utils.GeneralToolBox import HEINEKENPILOTCNGENERALToolBox
...
class HEINEKENPILOTCNToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = HEINEKENPILOTCNGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
        self.kpi_static_data = self.get_kpi_static_data()
        self.tamplate_tools = HEINEKENPILOTCNHandleTemplate(self.data_provider, output, kpi_static_data=self.kpi_static_data)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = HEINEKENPILOTCNQueries.get_all_kpi_data()
    ...
    def main_calculation(self):
        ...
        """
        kpi_set_fk = self.kpi_static_data.loc[self.kpi_static_data['kpi_set_name'] == AVAILABILITY]['kpi_set_fk'].iloc[
            0]
        ...
        for group in groups:
            ...
            if group_template.empty:
                ...
                atomic_fk = self.kpi_static_data.loc[(self.kpi_static_data['kpi_set_fk'] == kpi_set_fk) &
                                                     (self.kpi_static_data['kpi_name'] == group) &
    ...
    def calculate_group(self, group_data):
        ...
        for i in xrange(len(group_data)):
            ...
            elif self.BRAND in row['Entity'] or self.CATEGORY in row['Entity']:
    ...
    def commit_results_data(self):
        ...
        delete_queries = HEINEKENPILOTCNQueries.get_delete_session_results_query(self.session_uid)
