...
from Projects.HEINEKENPILOTCN.Utils.GeneralToolBox import HEINEKENCNHEINEKENPILOTCNGENERALToolBox
...
class HEINEKENPILOTCNTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = HEINEKENCNHEINEKENPILOTCNGENERALToolBox.get_json_data(file_path)
        else:
