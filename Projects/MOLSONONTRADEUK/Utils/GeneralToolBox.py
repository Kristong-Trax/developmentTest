...
from Projects.MOLSONONTRADEUK.Utils.PositionGraph import MOLSONONTRADEUKPositionGraphs

__author__ = 'Nimrod'


class MOLSONONTRADEUKGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = MOLSONONTRADEUKPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUMOLSONONTRADEUKGENERALToolBox.INCLUDE_FILTER)
