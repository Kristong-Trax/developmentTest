...
from Projects.MOLSONONTRADEUK.Utils.GeneralToolBox import GENERALToolBox
from Projects.MOLSONONTRADEUK.Utils.ParseTemplates import parse_template
...
class MOLSONONTRADEUKTemplateAsCache:
