...
from Projects.INBEVCO_SAND.Utils.Fetcher import INBEVCO_SANDQueries
from Projects.INBEVCO_SAND.Utils.GeneralToolBox import INBEVCO_SANDGENERALToolBox
...
class INBEVCO_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = INBEVCO_SANDGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = INBEVCO_SANDQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = INBEVCO_SANDQueries.get_delete_session_results_query(self.session_uid)
