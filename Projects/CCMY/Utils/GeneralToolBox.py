...
from Projects.CCMY.Utils.PositionGraph import CCMYPositionGraphs

__author__ = 'Nimrod'


class CCMYGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCMYPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
