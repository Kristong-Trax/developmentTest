...
class ProjectsSanityData(BaseSeedData):
    ...
    custom_ccanz_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                  FILES_RELATIVE_PATH: ['Data/Seeds/ccanz_seed_alter_table.sql.gz'],
                  PROJECT_NAME: project_name
                  }
    ccanz_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                  FILES_RELATIVE_PATH: ['Data/Seeds/ccanz_seed.sql.gz'],
                  PROJECT_NAME: project_name
                  }
