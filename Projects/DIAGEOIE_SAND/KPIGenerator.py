...
from Projects.DIAGEOIE_SAND.Utils.KPIToolBox import DIAGEOIESandToolBox, log_runtime

__author__ = 'Yasmin'


class DIAGEOIESandGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOIESandToolBox(self.data_provider, self.output)
