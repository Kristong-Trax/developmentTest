...
from Projects.DIAGEOIE_SAND.Utils.KPIToolBox import DIAGEOIE_SANDToolBox, log_runtime

__author__ = 'Yasmin'


class DIAGEOIE_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOIE_SANDToolBox(self.data_provider, self.output)
