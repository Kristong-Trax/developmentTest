...
from Projects.DIAGEOIE_SAND.Utils.GeneralToolBox import DIAGEOIEDIAGEOIE_SANDGENERALToolBox
from Projects.DIAGEOIE_SAND.Utils.ParseTemplates import parse_template
...
class DIAGEOIE_SANDTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOIEDIAGEOIE_SANDGENERALToolBox.get_json_data(file_path)
        else:
