...
class DIAGEOIE_SANDDIAGEOConsts(object):
...
class DIAGEOIE_SANDDIAGEOToolBox(DIAGEOIE_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOIE_SANDGENERALToolBox(data_provider, output, **data)
