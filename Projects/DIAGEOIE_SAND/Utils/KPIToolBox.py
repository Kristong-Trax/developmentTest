...
from Projects.DIAGEOIE_SAND.Utils.Fetcher import DIAGEOIE_SANDQueries
from Projects.DIAGEOIE_SAND.Utils.ToolBox import DIAGEOIE_SANDDIAGEOToolBox
# from Projects.DIAGEOIE_SAND.Utils.GeneralToolBox import DIAGEOIE_SANDGENERALToolBox
...
class DIAGEOIE_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOIE_SANDDIAGEOToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOIE_SANDQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOIE_SANDQueries.get_delete_session_results_query(self.session_uid)
