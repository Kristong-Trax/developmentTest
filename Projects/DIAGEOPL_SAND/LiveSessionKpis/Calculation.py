...
class CalculateKpi(LiveSessionBaseClass):
    ...
    def __init__(self, data_provider, output):
        ...
        self.assortment = DiageoAssortment(data_provider, self.common, False, False) #need to change to False, True
    ...
    def calculate_session_live_kpi(self):
        ...
        """
        assortment_results = self.assortment.main_assortment_calculation()
    ...
    #     lvl1 = self.assortment.calculate_lvl_1_assortment(lvl_2_result)
