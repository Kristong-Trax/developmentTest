...
from Projects.DIAGEOPL_SAND.Utils.KPIToolBox import DIAGEOPL_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOPL_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOPL_SANDToolBox(self.data_provider, self.output)
