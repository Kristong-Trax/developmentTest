...
from Projects.INTEG16.Utils.Fetcher import INTEG16Queries
from Projects.INTEG16.Utils.GeneralToolBox import INTEG16GENERALToolBox
from Projects.INTEG16.Utils.ParseComplexTemplates import parse_template
...
class INTEG16TemplateConsts(object):
...
class INTEG16ToolBox(INTEG16Consts):
    ...
    def __init__(self, data_provider, output):
        ...
        self.general_tools = INTEG16GENERALToolBox(self.data_provider, self.output)
        self.template = INTEG16TemplateConsts()
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = INTEG16Queries.get_all_kpi_data()
    ...
    def validate_kpi_run(self, params):
        ...
        if str(weight).isdigit():
            ...
            elif kpi_group in ('Cooler Space & Ambient Space', 'Cooler Space'):
    ...
    def calculate_share_of_shelf(self, params):
        ...
        target = float(params[self.template.TARGET])
        ...
        return score, result, target * 100
    ...
    def commit_results_data(self):
        ...
        delete_queries = INTEG16Queries.get_delete_session_results_query(self.session_uid)
