...
from Projects.INTEG16.Utils.PositionGraph import INTEG16PositionGraphs

__author__ = 'Nimrod'


class INTEG16GENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INTEG16PositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUINTEG16GENERALToolBox.INCLUDE_FILTER)
