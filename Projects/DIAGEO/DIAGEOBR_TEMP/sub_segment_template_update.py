...
from Projects.DIAGEO.DIAGEOBR_TEMP.sub_segment_toolBox import DIAGEOToolBox as Consts
...
class NewTemplate:
    ...
    def handle_updated_template(self, set_name, template_path, ignore_missings=False, replace_existing=False):
        ...
        """
        data = Consts.get_json_data(template_path, sheet_name=set_name)
        if data is None:
            return False
...
#             file_path = '/home/Yasmin/Desktop/diageo/BR/{}.xlsx'.format(set_name)
