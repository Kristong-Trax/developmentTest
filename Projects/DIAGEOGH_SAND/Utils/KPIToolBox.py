...
from Projects.DIAGEOGH_SAND.Utils.Fetcher import Queries
from Projects.DIAGEOGH_SAND.Utils.ToolBox import ToolBox
...
class DIAGEOToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = ToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
