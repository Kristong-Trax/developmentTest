...
from Projects.PNGMCCN_SAND.PositionGraph import PNGMCCN_SANDPositionGraphs
...
class PNGMCCN_SANDGENERALToolBox:
    ...
    def __init__(self, data_provider, output, kpi_static_data, geometric_kpi_flag=False):
        ...
        if geometric_kpi_flag:
            self.position_graphs = PNGMCCN_SANDPositionGraphs(self.data_provider)
    ...
    def check_survey_answer(self, survey_text, target_answer):
        ...
        if survey_data[answer_field].values and survey_data[answer_field].values[0] in target_answer:
            return True
        else:
            return False
    ...
    def calculate_relative_position(self, tested_filters, anchor_filters, direction_data, **general_filters):
        """
