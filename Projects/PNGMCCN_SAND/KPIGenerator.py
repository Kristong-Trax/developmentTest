...
from Projects.PNGMCCN_SAND.Utils.KPIToolBox import PNGMCCN_SANDToolBox

__author__ = 'Nimrod'


class PNGMCCN_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PNGMCCN_SANDToolBox(self.data_provider, self.output)
