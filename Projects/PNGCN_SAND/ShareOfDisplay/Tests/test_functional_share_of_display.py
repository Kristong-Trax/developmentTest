...
from Projects.PNGCN_SAND.ShareOfDisplay.Calculation import calculate_share_of_display, PNGCN_SANDPNGShareOfDisplay
from Trax.Apps.Core.Testing.BaseCase import TestFunctionalCase
from Trax.Data.Testing.TestProjects import TestProjectsNames
from Trax.Utils.Testing.Case import TestCase
from Projects.PNGCN_SAND.ShareOfDisplay.Tests.data_functional_test_share_of_display import \
    PNGCN_SANDInsertDataIntoMySqlProjectSOD, PNGCN_SANDSodTestSeedData
from Trax.Data.Testing.SeedNew import Seeder
from Projects.PNGCN_SAND.ShareOfDisplay.Tests.ShareOfDisaplyTestsQueries import get_display_surface_by_scene_query, \
...
MOCK_PATH = 'Projects.PNGCN_SAND.ShareOfDisplay.Calculation'


class PNGCN_SANDTestShareOfDisplay(TestFunctionalCase):
    ...
    @classmethod
    @seeder.seed(['sql_sod'], PNGCN_SANDSodTestSeedData())
    def setUpClass(cls):
        super(PNGCN_SANDTestShareOfDisplay, cls).setUpClass()
        cls._data_input_project_1 = PNGCN_SANDInsertDataIntoMySqlProjectSOD(cls._project1)
    ...
    def test_previous_data_is_deleted_correctly(self):
        ...
        sod = PNGCN_SANDPNGShareOfDisplay(self._data_input_project_1._conn, session, data_provider=None)
