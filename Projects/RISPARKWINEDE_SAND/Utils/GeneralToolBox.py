...
from Projects.RISPARKWINEDE_SAND.Utils.PositionGraph import RISPARKWINEDEPositionGraphs

__author__ = 'Nimrod'


class RISPARKWINEDEGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAURISPARKWINEDEGENERALToolBox.INCLUDE_FILTER)
