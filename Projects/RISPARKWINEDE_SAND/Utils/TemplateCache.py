...
from Projects.RISPARKWINEDE_SAND.Utils.GeneralToolBox import GENERALToolBox
from Projects.RISPARKWINEDE_SAND.Utils.ParseTemplates import parse_template
...
class RISPARKWINEDETemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = GENERALToolBox.get_json_data(file_path)
        else:
