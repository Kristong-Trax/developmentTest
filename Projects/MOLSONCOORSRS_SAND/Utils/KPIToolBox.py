...
from Projects.MOLSONCOORSRS_SAND.Utils.ParseTemplates import parse_template
from Projects.MOLSONCOORSRS_SAND.Utils.Fetcher import MOLSONCOORSRS_SANDQueries


__author__ = 'sergey'

KPIS_TEMPLATE_NAME = 'MOLSONCOORS_RS_KPIs.xlsx'
...
class MOLSONCOORSRS_SANDToolBox:
    ...
    def get_sos_store_policies(self, visit_date):
        query = MOLSONCOORSRS_SANDQueries.get_sos_store_policies(visit_date)
        store_policies = pd.read_sql_query(query, self.rds_conn.db)
        return store_policies

    def get_result_values(self):
        query = MOLSONCOORSRS_SANDQueries.get_result_values()
