...
from Projects.DIAGEOBENELUX.Utils.GeneralToolBox import DIAGEOBENELUXGENERALToolBox
...
class DIAGEOBENELUXDIAGEOConsts(object):
    ...
    AVAILABILITY_SETS = ['Local MPA','MPA', 'New Products', 'POSM']
    KPI_SETS_WITH_PERCENT_AS_SCORE = AVAILABILITY_SETS + ['Visible to Customer', 'Relative Position',
                                                          'Brand Blocking', 'Activation Standard', 'Survey Questions']
    KPI_SETS_WITHOUT_A_TEMPLATE = ['Secondary', 'Visible to Customer',
                                   'Local MPA','POSM', 'Relative Position', 'Brand Blocking',
                                   'Activation Standard', 'Survey Questions', 'Brand Pouring'
                                   ]
    TEMPLATES_PATH = 'Diageo_templates/'
    KPI_NAME = KPI_NAME


class DIAGEOBENELUXDIAGEOToolBox(DIAGEOBENELUXDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOBENELUXGENERALToolBox(data_provider, output, **data)
    ...
    def get_survey_answer(self, survey_data, answer_field=None):
        ...
        """
        return self.general_tools.get_survey_answer(survey_data, answer_field)
