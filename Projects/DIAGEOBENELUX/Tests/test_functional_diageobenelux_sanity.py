...
from Projects.DIAGEOBENELUX.Tests.Data.data_test_diageobenelux_sanity import ProjectsSanityData
from Projects.DIAGEOBENELUX.Calculations import DIAGEOBENELUXCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.DIAGEOBENELUX.Tests.Data.kpi_results import DIAGEOBENELUXKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["diageobenelux_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
