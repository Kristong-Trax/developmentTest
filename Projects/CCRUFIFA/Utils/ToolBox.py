...
from Projects.CCRUFIFA.Utils.Fetcher import CCRUFIFAQueries
...
class CCRUFIFAKPIToolBox:
    def __init__(self, data_provider, output, set_name=None):
        ...
        self.kpi_fetcher = CCRUFIFAQueries(self.project_name, self.scif, self.match_product_in_scene, self.set_name)
