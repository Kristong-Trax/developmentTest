...
from Projects.DIAGEOAR.Utils.PositionGraph import DIAGEOARDIAGEOARPositionGraphs

__author__ = 'Nimrod'


class DIAGEOARDIAGEOARGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOARDIAGEOARPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOARDIAGEOARGENERALToolBox.INCLUDE_FILTER)
