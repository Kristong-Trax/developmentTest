...
class DIAGEOARDIAGEOConsts(object):
...
class DIAGEOARDIAGEOToolBox(DIAGEOARDIAGEOConsts):
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOAUDIAGEOARDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOAUDIAGEOARDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOAUDIAGEOARDIAGEOToolBox.DIAGEO
