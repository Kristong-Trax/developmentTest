...
from Projects.DIAGEOAR.Utils.ParseTemplates import parse_template
...
class DIAGEOARDIAGEOARTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOARDIAGEOARGENERALToolBox.get_json_data(file_path)
        else:
