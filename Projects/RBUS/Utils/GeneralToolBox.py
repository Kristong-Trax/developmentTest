...
from Projects.RBUS.Utils.PositionGraph import RBUSRBUSPositionGraphs

__author__ = 'Nimrod'


class RBUSRBUSGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = RBUSRBUSPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAURBUSRBUSGENERALToolBox.INCLUDE_FILTER)
