...
class MarsUkPositionGraphs:
    ...
    def get_filtered_matches(self, include_stacking=False):
        ...
        matches = matches.merge(self.data_provider[Data.SCENE_ITEM_FACTS][['template_name', 'template_display_name',
                                                                           'location_type', 'scene_id', 'scene_fk']],
