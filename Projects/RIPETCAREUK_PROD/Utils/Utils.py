...
def get_kpi_static_data_by_set(set_name, rds_conn):
    """
    This function extracts the static KPI data and saves it into one global data frame.
    The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
    """
    query = MarsUkQueries.get_all_kpi_data_by_set(set_name)
...
def get_all_kpi_static_data(rds_conn):
    ...
    The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
    """
    query = MarsUkQueries.get_all_kpi_data()
    kpi_static_data = pd.read_sql_query(query, rds_conn)
    return kpi_static_data


def get_kpi_set_static_data(rds_conn):
    """
    This function extracts the static KPI data and saves it into one global data frame.
    The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
    """
    query = MarsUkQueries.get_kpi_set_data()
    kpi_static_data = pd.read_sql_query(query, rds_conn)
    return kpi_static_data


def get_kpi_static_data(rds_conn):
    """
    This function extracts the static KPI data and saves it into one global data frame.
    The data is taken from static.kpi / static.atomic_kpi / static.kpi_set.
    """
    query = MarsUkQueries.get_kpi_data()
    kpi_static_data = pd.read_sql_query(query, rds_conn)
    return kpi_static_data
