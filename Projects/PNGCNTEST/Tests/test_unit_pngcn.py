...
from Projects.PNGCNTEST.SceneKpis.KPISceneToolBox import PngcnSceneKpis
from Projects.PNGCNTEST.KPIToolBox import PNGToolBox
import Projects.PNGCNTEST.Tests.Data.records as r
...
class TestPngcn(TestUnitCase):
    ...
    def import_path(self):
        return 'Projects.PNGCNTEST.SceneKpis.KPISceneToolBox'
    ...
    def set_up(self):
        ...
        self.ProjectConnector_mock = self.mock_object(
            'get_png_manufacturer_fk', path='Projects.PNGCNTEST.SceneKpis.KPISceneToolBox.PngcnSceneKpis')
        self.ProjectConnector_mock.return_value = 4

        self.matches_mock = self.mock_object(
            'get_match_product_in_scene', path='Projects.PNGCNTEST.KPIToolBox.PNGToolBox')
