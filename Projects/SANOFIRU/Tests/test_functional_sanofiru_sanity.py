...
from Projects.SANOFIRU.Tests.Data.data_test_sanofiru_sanity import ProjectsSanityData
from Projects.SANOFIRU.Calculations import SANOFIRUCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.SANOFIRU.Tests.Data.kpi_results import SANOFIRUKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["sanofiru_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
