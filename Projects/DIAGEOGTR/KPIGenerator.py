...
from Projects.DIAGEOGTR.Utils.KPIToolBox import DIAGEOGTRDIAGEOGTRToolBox, log_runtime

__author__ = 'Yasmin'


class DIAGEOGTRDIAGEOGTRGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOGTRDIAGEOGTRToolBox(self.data_provider, self.output)
