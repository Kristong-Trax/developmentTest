...
from Projects.DIAGEOGTR.Utils.Fetcher import DIAGEOGTRDIAGEOGTRQueries
from Projects.DIAGEOGTR.Utils.GeneralToolBox import DIAGEOGTRDIAGEOGTRGENERALToolBox
from Projects.DIAGEOGTR.Utils.ToolBox import DIAGEOGTRDIAGEOGTRDIAGEOToolBox
...
class DIAGEOGTRDIAGEOGTRToolBox:
    LEVEL1 = 1
    LEVEL2 = 2
    LEVEL3 = 3
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOGTRDIAGEOGTRDIAGEOToolBox(self.data_provider, output, kpi_static_data=self.kpi_static_data,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOGTRDIAGEOGTRQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOGTRDIAGEOGTRQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOGTRDIAGEOGTRQueries.get_delete_session_results_query(self.session_uid)
