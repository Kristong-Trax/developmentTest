...
from Projects.DIAGEOGTR.Utils.ParseTemplates import parse_template
...
class DIAGEOGTRDIAGEOGTRTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOGTRDIAGEOGTRGENERALToolBox.get_json_data(file_path)
        else:
