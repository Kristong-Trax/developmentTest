...
from Projects.KCUS_SAND.Utils.PositionGraph import KCUS_SANDPositionGraphs
...
class KCUS_SANDGENERALToolBox:
    ...
    def __init__(self, data_provider, output, geometric_kpi_flag=False, **kwargs):
        ...
        if geometric_kpi_flag:
            self.position_graph_data = KCUS_SANDPositionGraphs(self.data_provider)
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = KCUS_SANDPositionGraphs(self.data_provider)
