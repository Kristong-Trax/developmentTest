...
class KCUS_SANDToolBox:
    ...
    def calculate_assort(self,params):
        ...
        entity1 = params.get('Entity 1')
        if entity1 is not None:
            filter_by1[entity1] = [str(s) for s in params.get('Tested Entity 1').split(', ')]
        anchor1 = params.get('Anchor Entity 1')
        if anchor1 is not None:
            filter_by1[anchor1] = [str(s) for s in params.get('Anchor param 1').split(', ')]
        entity2 = params.get('Entity 2')
        if entity2 is not None:
            filter_by2[entity2] = [str(s) for s in params.get('Tested Entity 2').split(', ')]
