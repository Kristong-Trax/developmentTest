...
from Projects.NESTLEIL_SAND.Tests.data_test_unit_nestleil_sand import DataTestUnitNestleil
...
class TestNestleilSand(TestFunctionalCase):
    ...
    def import_path(self):
        return 'Projects.NESTLEIL_SAND.Utils.KPIToolBox'

    def set_up(self):
        super(TestNestleilSand, self).set_up()
