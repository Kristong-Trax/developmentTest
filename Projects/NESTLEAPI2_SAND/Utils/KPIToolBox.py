...
from Projects.NESTLEAPI2_SAND.Utils.Fetcher import NESTLEAPI2_SANDNESTLEAPIQueries
from Projects.NESTLEAPI2_SAND.Utils.GeneralToolBox import NESTLEAPI2_SANDNESTLEAPIGENERALToolBox
from Projects.NESTLEAPI2_SAND.Utils.ParseTemplates import parse_template
...
class NESTLEAPI2_SANDNESTLEAPIToolBox:
    LEVEL1 = 1
    LEVEL2 = 2
    LEVEL3 = 3
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = NESTLEAPI2_SANDNESTLEAPIGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = NESTLEAPI2_SANDNESTLEAPIQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = NESTLEAPI2_SANDNESTLEAPIQueries.get_delete_session_results_query(self.session_uid)
