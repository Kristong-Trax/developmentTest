...
from Projects.NESTLEAPI2_SAND.Utils.PositionGraph import NESTLEAPI2_SANDNESTLEAPIPositionGraphs

__author__ = 'Nimrod'


class NESTLEAPI2_SANDNESTLEAPIGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = NESTLEAPI2_SANDNESTLEAPIPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUNESTLEAPI2_SANDNESTLEAPIGENERALToolBox.INCLUDE_FILTER)
