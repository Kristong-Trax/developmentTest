...
class TestPngcn(TestUnitCase):
    ...
    #           'category': 'Oral Care', 'product_fk': 252, 'stacking_layer': 1, 'category_fk': 101, 'sub_category_fk': 2,
    #           'bay_number': 1, 'shelf_number': 2, 'facing_sequence_number': 3, 'sub_brand': 'sb1', 'att3': "a1",
    #           'brand_fk': 2},
    #          {'scene_fk': 16588190, 'manufacturer_name': 'P&G\xe5\xae\x9d\xe6\xb4\x81', 'brand_name': 'Oral-B',
    #           'category': 'Oral Care', 'product_fk': 132, 'stacking_layer': 1, 'category_fk': 101, 'sub_category_fk': 1,
    #           'bay_number': 1, 'shelf_number': 2, 'facing_sequence_number': 3, 'sub_brand': 'sb2', 'att3': "a1",
    #           'brand_fk': 2},
    #          {'scene_fk': 16588190, 'manufacturer_name': 'P&G\xe5\xae\x9d\xe6\xb4\x81', 'brand_name': 'Oral-B',
    #           'category': 'Oral Care', 'product_fk': 999, 'stacking_layer': 1, 'category_fk': 101, 'sub_category_fk': 2,
    #           'bay_number': 1, 'shelf_number': 2, 'facing_sequence_number': 3, 'sub_brand': 'HOLA', 'att3': "a2",
    #           'brand_fk': 2},
    #          {'scene_fk': 16588190, 'manufacturer_name': 'P&G\xe5\xae\x9d\xe6\xb4\x81', 'brand_name': 'Crest',
    #           'category': 'Oral Care', 'product_fk': 152, 'stacking_layer': 1, 'category_fk': 102, 'brand_fk': 2,
    #           'bay_number': 2, 'shelf_number': 2, 'facing_sequence_number': 1, 'sub_category_fk': 1},
    ...
    #           'bay_number': 2, 'shelf_number': 2, 'facing_sequence_number': 3, 'sub_category_fk': 1, 'att3': "a2",
    #           'sub_brand': 'HOLA', 'brand_fk': 2},
    #          {'scene_fk': 16588190, 'manufacturer_name': 'P&G\xe5\xae\x9d\xe6\xb4\x81', 'brand_name': 'hola',
    #           'category': 'Oral Care', 'product_fk': 173, 'stacking_layer': 1, 'category_fk': 101, 'sub_category_fk': 2,
    #           'bay_number': 2, 'shelf_number': 2, 'facing_sequence_number': 2, 'sub_brand': 'HOLA', 'brand_fk': 3}])
    #
    #     scene_tool_box.get_filterd_matches = MagicMock(return_value=pd.DataFrame(data))
    #     scene_tool_box.common.write_to_db_result = MagicMock()
    #     scene_tool_box.calculate_sequence_eye_level(5, data)
    #     kpi_results = scene_tool_box.common.write_to_db_result.mock_calls
    #     if kpi_results:
