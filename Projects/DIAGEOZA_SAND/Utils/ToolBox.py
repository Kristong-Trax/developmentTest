...
from Projects.DIAGEOZA_SAND.Utils.GeneralToolBox import DIAGEOZA_SANDGENERALToolBox
...
class DIAGEOZA_SANDDIAGEOConsts(object):
...
class DIAGEOZA_SANDDIAGEOToolBox(DIAGEOZA_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOZA_SANDGENERALToolBox(data_provider, output, **data)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOZA_SANDDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOZA_SANDDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOZA_SANDDIAGEOToolBox.DIAGEO
