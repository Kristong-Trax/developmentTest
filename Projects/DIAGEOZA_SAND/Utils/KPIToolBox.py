...
from Projects.DIAGEOZA_SAND.Utils.Fetcher import DIAGEOZA_SANDQueries
from Projects.DIAGEOZA_SAND.Utils.ToolBox import DIAGEOZA_SANDDIAGEOToolBox
...
class DIAGEOZA_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOZA_SANDDIAGEOToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOZA_SANDQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOZA_SANDQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOZA_SANDQueries.get_delete_session_results_query(self.session_uid)
