...
class CCRU_SANDQsr2018Calculations:
    ...
    def __init__(self, data_provider, output, ps_data_provider):
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, QSR_2018)
        self.results = {}
    ...
    def main_function(self):
        ...
        jg.create_json('QSR PoS 2018.xlsx', QSR_2018)
        ...
        jg.create_gaps_json('gaps_guide_2018.xlsx', sheet_name=QSR_2018)
        ...
        jg.create_equipment_json('Contract Execution 2018.xlsx', QSR_2018)
