...
class CCRU_SANDFastFoodCalculations:
    ...
    def __init__(self, data_provider, output, ps_data_provider):
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, FAST_FOOD)
    ...
    def main_function(self):
        ...
        attributes_for_table1 = pd.DataFrame([(FAST_FOOD, self.session_uid,
        ...
        jg.create_gaps_json('gaps_guide.xlsx', sheet_name=FAST_FOOD)
