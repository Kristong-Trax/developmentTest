...
class CCRU_SANDHoReCaCalculations:
    ...
    def __init__(self, data_provider, output, ps_data_provider):
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, HORECA)
    ...
    def main_function(self):
        ...
        jg.create_gaps_json('gaps_guide.xlsx', sheet_name=HORECA)
