...
class CCRU_SANDPetrol2018Calculations:
    def __init__(self, data_provider, output, ps_data_provider):  # All relevant session data with KPI static info will trigger the KPI calculation
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, PETROL_2018)
    ...
    def main_function(self):
        ...
        attributes_for_table1 = pd.DataFrame([(PETROL_2018, self.session_uid,
