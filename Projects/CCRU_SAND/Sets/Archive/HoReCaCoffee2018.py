...
class CCRU_SANDHRCCoffee2018Calculations:
    def __init__(self, data_provider, output, ps_data_provider):  # All relevant session data with KPI static info will trigger the KPI calculation
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, HRC_COFFEE_2018)
        self.results = {}
    ...
    def main_function(self):
        ...
        attributes_for_table1 = pd.DataFrame([(HRC_COFFEE_2018, self.session_uid,
        ...
        jg.create_equipment_json('Contract Execution 2018.xlsx', HRC_COFFEE_2018)
