...
TARGET_EXECUTION = 'Target Execution 2017'  # todo: is this should be kept the same?
...
class CCRU_SANDConvenienceSmallCalculations:
    ...
    def __init__(self, data_provider, output, ps_data_provider):
        ...
        self.tool_box = CCRU_SANDKPIToolBox(
            self.data_provider, self.output, ps_data_provider, CONVENIENCE_SMALL_2018)
    ...
    def main_function(self):
        ...
        jg.create_json('Convenience Small PoS 2018.xlsx', CONVENIENCE_SMALL_2018)
        ...
        score += self.tool_box.check_atomic_passed_on_the_same_scene(
        ...
        score += self.tool_box.check_share_of_cch(jg.project_kpi_dict.get('kpi_data')[0])  # TODO
        attributes_for_table1 = pd.DataFrame([(CONVENIENCE_SMALL_2018, self.session_uid,
        ...
        # jg.create_gaps_json('gaps_guide.xlsx', sheet_name=CONVENIENCE_SMALL_2018)  # todo: fix this function
