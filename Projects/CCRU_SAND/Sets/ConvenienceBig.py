...
class CCRU_SANDConvenienceBigCalculations:
    ...
    def __init__(self, data_provider, output, ps_data_provider):
        ...
        self.tool_box = CCRU_SANDKPIToolBox(self.data_provider, self.output, ps_data_provider, CBS)
    ...
    def main_function(self):
        ...
        attributes_for_table1 = pd.DataFrame([(CBS, self.session_uid,
