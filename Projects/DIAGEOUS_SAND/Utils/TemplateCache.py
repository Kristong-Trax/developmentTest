...
from Projects.DIAGEOUS_SAND.Utils.ParseTemplates import parse_template
...
class DIAGEOUSTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOUSGENERALToolBox.get_json_data(file_path)
        else:
