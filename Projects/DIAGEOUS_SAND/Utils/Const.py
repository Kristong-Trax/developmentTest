...
class Const(object):
    ...
    DB_POD_SKU = 'POD_presence_SKU_%'

    DB_COMPLIANCE_TOTAL = 'Dispaly_Compliance_score_total_%'
    DB_COMPLIANCE_SEGMENT = 'Dispaly_Compliance_score_segment_%'
    DB_COMPLIANCE_NATIONAL = 'Dispaly_Compliance_score_national_%'
    DB_COMPLIANCE_BRAND = 'Dispaly_Compliance_Brand_%'
    DB_COMPLIANCE_SUB_BRAND = 'Dispaly_Compliance_Sub_Brand_%'
    DB_COMPLIANCE_SKU = 'Dispaly_Presence_SKU'

    DB_DISPLAY_SHARE_TOTAL = 'Dispaly_Share_score_total_%'
    DB_DISPLAY_SHARE_MANUFACTURER = 'Dispaly_Share_Manufacturer_%'
    DB_DISPLAY_SHARE_SKU = 'Dispaly_Share_SKU'
    ...
    DB_SHELF_PLACEMENT_TOTAL = 'Dispaly_Shelf_Placements_score_total_%'
    DB_SHELF_PLACEMENT_SEGMENT = 'Dispaly_Shelf_Placements_score_segment_%'
    DB_SHELF_PLACEMENT_NATIONAL = 'Dispaly_Shelf_Placements_score_national_%'
    DB_SHELF_PLACEMENT_BRAND = 'Dispaly_Shelf_Placements_Brand_%'
    DB_SHELF_PLACEMENT_SUB_BRAND = 'Dispaly_Shelf_Placements_Sub_brand_%'
    DB_SHELF_PLACEMENT_SKU = 'Dispaly_Shelf_Placements_SKU_status'
