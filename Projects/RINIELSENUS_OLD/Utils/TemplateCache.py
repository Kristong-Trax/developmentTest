...
from Projects.RINIELSENUS_OLD.Utils.ParseTemplates import parse_template
...
class RINIELSENUSTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = RINIELSENUSGENERALToolBox.get_json_data(file_path)
        else:
