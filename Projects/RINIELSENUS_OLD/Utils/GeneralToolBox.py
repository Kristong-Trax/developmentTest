...
from Projects.RINIELSENUS_OLD.Utils.PositionGraph import RINIELSENUSPositionGraphs as PositionGraphs

__author__ = 'Nimrod'


class RINIELSENUSGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAURINIELSENUSGENERALToolBox.INCLUDE_FILTER)
