...
from Projects.RINIELSENUS_OLD.Utils.KPIToolBox import RINIELSENUSToolBox, log_runtime

__author__ = 'uri'


class RINIELSENUSGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = RINIELSENUSToolBox(self.data_provider, self.output)
