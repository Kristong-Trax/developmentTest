...
from Projects.MJNCN.Utils.ParseTemplates import parse_template
from Projects.MJNCN.Utils.Fetcher import MJNCNQueries
from Projects.MJNCN.Utils.GeneralToolBox import MJNCNGENERALToolBox
...
class MJNCNToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = MJNCNGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
        self.kpi_static_data = self.get_kpi_static_data()
        self.kpi_results_queries = []
        self.custom_templates = {}
        self.store_info = self.data_provider[Data.STORE_INFO]
        self.store_type = self.store_info['store_type'].iloc[0]
        self.store_att1 = self.store_info['additional_attribute_1'].iloc[0]
        self.scif_filters = {'Product EAN': 'product_ean_code', 'Template Name':'template_name'}
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = MJNCNQueries.get_all_kpi_data()
    ...
    def main_calculation(self, kpi_set_fk):
        ...
        for index, row in kpi_template.iterrows():
            ...
            if row['KPI Type'] == 'Facing Count':
                ...
                score = self.count_facing(kpi_set_fk, relevant_tab, must_have_sku)
    ...
    def count_facing(self, set_fk, tab, relevant_kpi):
        ...
        filters_to_get = ['Product EAN', 'Template Name']
        if 'att1' in template.columns.tolist():
            template = template.loc[template['att1'] == self.store_att1]
        for i in xrange(len(template)):
            ...
            self.write_to_level_2_and_3(kpi_name=kpi_name, atomic_name=kpi_name,
                                        result=result, score=score, set_fk=set_fk)
    ...
    def count_posm(self, kpi_name, scene_type):
        ...
        filters = {'template_name': relevant_displays}
    ...
    def commit_results_data(self):
        ...
        delete_queries = MJNCNQueries.get_delete_session_results_query(self.session_uid)
