...
from Projects.DIAGEOAR_SAND.Utils.ParseTemplates import parse_template
...
class DIAGEOARTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = DIAGEOARGENERALToolBox.get_json_data(file_path)
        else:
