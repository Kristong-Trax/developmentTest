...
class Consts(object):
    ...
    SOS_FACINGS_MANUF_CAT_BY_ALL_MANUF_CAT_IN_SCENE_TYPE = MANUFACTURE_NAME + COUNTRY
    SOS_FACINGS_MANUF_CAT_BY_ALL_MANUF_CAT_IN_SCENE_TYPE += "_FSOS_MANUF_CAT_BY_ALL_MANUF_CAT_IN_SCENE_TYPE"
