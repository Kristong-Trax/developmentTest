...
from Projects.HEINEKENCN_SAND.Utils.PositionGraph import HEINEKENCNPositionGraphs
...
class HEINEKENCNGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUHEINEKENCNGENERALToolBox.INCLUDE_FILTER)
