...
from Projects.INBEVBR.Utils.PositionGraph import INBEVBRPositionGraphs

__author__ = 'Nimrod'


class INBEVBRGENERALToolBox:
    ...
    def __init__(self, data_provider, output, rds_conn=None, ignore_stacking=False, front_facing=False,
                 geometric_kpi_flag=False, **kwargs):
        ...
        if geometric_kpi_flag:
            self.position_graph_data = INBEVBRPositionGraphs(self.data_provider)
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVBRPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', INBEVBRGENERALToolBox.INCLUDE_FILTER)
