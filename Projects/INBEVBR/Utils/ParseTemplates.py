...
def parse_template(template_path, sheet_name=None, lower_headers_row_index=0, upper_headers_row_index=None,
                   ...
                   columns_for_vertical_padding=[], converters=None):
    """
    ...
    """
    data = pd.read_excel(template_path, sheetname=sheet_name, skiprows=lower_headers_row_index, conventers=converters)
                    ...
                    if not duplicates:
                        ...
                        for sub_duplicate in sub_duplicates:
                            for duplicate in duplicates:
                                new_duplicates.append('{0}{1}{2}'.format(duplicate, output_column_name_separator,
                                                                         sub_duplicate))
