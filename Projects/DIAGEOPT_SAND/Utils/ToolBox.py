...
from Projects.DIAGEOPT_SAND.Utils.GeneralToolBox import DIAGEOPT_SANDGENERALToolBox
...
class DIAGEOPT_SANDDIAGEOConsts(object):
    ...
    KPI_SETS = ['MPA products availability', 'New Products Availability', 'MPA', 'Local MPA', 'New Products', 'POSM', 'Secondary Displays', 'Relative Position', 'Brand Blocking',
                'Visible to Customer', 'Activation Standard', 'Survey Questions', 'Brand Pouring']
    KPI_SETS_WITH_PERCENT_AS_SCORE = ['MPA products availability', 'New Products', 'POSM', 'Visible to Customer',
                                      'Relative Position',
                                      'Brand Blocking', 'Activation Standard', 'Survey Questions', 'Local MPA']
    KPI_SETS_WITHOUT_A_TEMPLATE = ['Secondary Displays', 'Visible to Consumer %']
...
class DIAGEOPT_SANDDIAGEOToolBox(DIAGEOPT_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOPT_SANDGENERALToolBox(data_provider, output, **data)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOPT_SANDDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOPT_SANDDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOPT_SANDDIAGEOToolBox.DIAGEO
