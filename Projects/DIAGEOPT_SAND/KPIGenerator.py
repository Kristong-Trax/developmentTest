...
from Projects.DIAGEOPT_SAND.Utils.KPIToolBox import DIAGEOPT_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOPT_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOPT_SANDToolBox(self.data_provider, self.output)
