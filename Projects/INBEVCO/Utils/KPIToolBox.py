...
from Projects.INBEVCO.Utils.Fetcher import INBEVCOINBEVCOQueries
from Projects.INBEVCO.Utils.GeneralToolBox import INBEVCOINBEVCOGENERALToolBox
...
class INBEVCOINBEVCOToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = INBEVCOINBEVCOGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = INBEVCOINBEVCOQueries.get_all_kpi_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = INBEVCOINBEVCOQueries.get_delete_session_results_query(self.session_uid)
