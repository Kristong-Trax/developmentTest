...
from Projects.INBEVCO.Utils.ParseTemplates import parse_template
...
class INBEVCOINBEVCOTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = INBEVCOINBEVCOGENERALToolBox.get_json_data(file_path)
        else:
