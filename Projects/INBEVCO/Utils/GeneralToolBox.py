...
from Projects.INBEVCO.Utils.PositionGraph import INBEVCOINBEVCOPositionGraphs

__author__ = 'Nimrod'


class INBEVCOINBEVCOGENERALToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    CONTAIN_FILTER = 2
    EXCLUDE_EMPTY = False
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVCOINBEVCOPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUINBEVCOINBEVCOGENERALToolBox.INCLUDE_FILTER)
