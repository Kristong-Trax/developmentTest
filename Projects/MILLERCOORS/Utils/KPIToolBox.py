...
from Projects.MILLERCOORS.Utils import Const
from Projects.MILLERCOORS.Utils.Fetcher import MILLERCOORSQueries
...
class MILLERCOORSToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.common_db = Common(self.data_provider, kpi=Const.KPS_NAME)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = MILLERCOORSQueries.get_all_kpi_data()
    ...
    def main_calculation(self, *args, **kwargs):
        ...
        """
        # score = GENERALToolBox.calculate_number_of_scenes(self.tools, template_name='Doors')
        # score = GENERALToolBox.match_product_in_scene(self.tools, template_name='Doors')
        df = self._get_match_display_in_scene_data()
        kpi_fk = kwargs.get('kpi_set_fk')
        count = df[df.display_fk == 26].count()['display_size']
        self.write_to_db_result(fk=kpi_fk, score=count, level=self.common_db.LEVEL3)
    ...
    def commit_results_data(self):
        ...
        delete_queries = MILLERCOORSQueries.get_delete_session_results_query(self.session_uid)
    ...
    def _get_match_display_in_scene_data(self):
        ...
        match_display_in_scene = pd.read_sql_query(query, self.rds_conn.db)
