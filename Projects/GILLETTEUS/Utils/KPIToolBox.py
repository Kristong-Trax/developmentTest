...
from Projects.GILLETTEUS.Utils.Fetcher import GILLETTEUSQueries
from Projects.GILLETTEUS.Utils.GeneralToolBox import GILLETTEUSGENERALToolBox
...
class GILLETTEUSTemplateConsts(object):
...
class GILLETTEUSToolBox(GILLETTEUSTemplateConsts):
    LEVEL1 = 1
    LEVEL2 = 2
    LEVEL3 = 3
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = GILLETTEUSQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = GILLETTEUSQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = GILLETTEUSQueries.get_delete_session_results_query(self.session_uid)
