...
from Projects.DIAGEOBR_SAND.Utils.PositionGraph import DIAGEOBR_SANDPositionGraphs

__author__ = 'Nimrod'


class DIAGEOBR_SANDGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = DIAGEOBR_SANDPositionGraphs(self.data_provider)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOBR_SANDGENERALToolBox.INCLUDE_FILTER)
