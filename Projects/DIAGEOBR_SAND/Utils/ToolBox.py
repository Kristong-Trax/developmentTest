...
from Projects.DIAGEOBR_SAND.Utils.GeneralToolBox import DIAGEOBR_SANDGENERALToolBox
...
class DIAGEOBR_SANDDIAGEOConsts(object):
...
class DIAGEOBR_SANDDIAGEOToolBox(DIAGEOBR_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOBR_SANDGENERALToolBox(data_provider, output, **data)
