...
from Projects.DIAGEOBR_SAND.Utils.KPIToolBox import DIAGEOBR_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOBR_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOBR_SANDToolBox(self.data_provider, self.output)
