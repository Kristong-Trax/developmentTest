...
from Projects.EXPD_20200416_932_CCAAU.Calculations import Calculations


if __name__ == '__main__':
    LoggerInitializer.init('expd-20200416-932-ccaau INTEG ENV calculations')
    Config.init()
    project_name = 'expd-20200416-932-ccaau'
