...
from Projects.PNGRO_SAND.Utils.KPIToolBox import PNGROToolBox, log_runtime

__author__ = 'Israel'


class PNGROGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PNGROToolBox(self.data_provider, self.output)
