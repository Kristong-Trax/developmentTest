...
sys.path.append('.')
from Projects.RNBDE_SAND.Utils.Fetcher import RNBDE_SANDQueries
from Projects.RNBDE_SAND.Utils.GeneralToolBox import RNBDE_SANDGENERALToolBox
...
class RNBDE_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = RNBDE_SANDGENERALToolBox(self.data_provider, output,
    ...
    def general_tools(self):
        if not hasattr(self, '_general_tools'):
            self._general_tools = RNBDE_SANDGENERALToolBox(self.data_provider, self.output)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = RNBDE_SANDQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = RNBDE_SANDQueries.get_match_display(self.session_uid)
        match_display = pd.read_sql_query(query, self.rds_conn.db)
        return match_display

    def get_store_retailer(self):
        query = RNBDE_SANDQueries.get_retailer(self.store_id)
    ...
    def calculate_footcare_eye_level_sets(self, set_name, category_name):
        ...
        for params in self.set_templates_data[category_name]:
            ...
            if params.get(self.tools.FORMULA) == 'Shelf Position':
                ...
                kpi_results_dict['Hardskin & Nail Separation'] = min(score,
    ...
    def commit_results_data(self):
        ...
        delete_queries = RNBDE_SANDQueries.get_delete_session_results_query(self.session_uid)
