...
from Projects.SANOFIUZ.Tests.Data.data_test_sanofiuz_sanity import ProjectsSanityData
from Projects.SANOFIUZ.Calculations import SANOFIUZCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.SANOFIUZ.Tests.Data.kpi_results import SANOFIUZKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["sanofiuz_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_sanofiuz_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {u'AF1CFB5F-FE39-4C13-A2D5-24C5BD375FDD': []}
        kpi_results = SANOFIUZKpiResults().get_kpi_results()
