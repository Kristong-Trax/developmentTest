...
class ProjectsSanityData(BaseSeedData):
    ...
    inbevci_seed = {DATA_TYPE: BaseSeedData.MYSQL,
                    FILES_RELATIVE_PATH: ['Data/Seeds/inbevci_seed.sql.gz'],
                    PROJECT_NAME: project_name
                    }
    inbevci_seed_2 = {DATA_TYPE: BaseSeedData.MYSQL,
                      FILES_RELATIVE_PATH: ['Data/Seeds/kpi_targets_seed.sql'],
                      PROJECT_NAME: project_name
                      }
