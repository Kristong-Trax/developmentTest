...
from Projects.INBEVCI.Utils.PositionGraph import INBEVCIINBEVCIPositionGraphs

__author__ = 'Nimrod'


class INBEVCIINBEVCIGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVCIINBEVCIPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
