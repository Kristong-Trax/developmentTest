...
from Projects.INBEVCI.Utils.GeneralToolBox import INBEVCIINBEVCIGENERALToolBox
...
class INBEVCIINBEVCITemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = INBEVCIINBEVCIGENERALToolBox.get_json_data(file_path)
        else:
