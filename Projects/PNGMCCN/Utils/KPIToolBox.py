...
from Projects.PNGMCCN.GeneralToolBox import GENERALToolBox
from Projects.PNGMCCN.Utils.Fetcher import PNGMCCNQueries
...
class PNGMCCNToolBox:
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = PNGMCCNQueries.get_all_kpi_data()
    ...
    def get_missing_attributes_data(self):
        ...
        """
        query = PNGMCCNQueries.get_attributes_data()
    ...
    def commit_results_data(self):
        ...
        delete_queries = PNGMCCNQueries.get_delete_session_results_query(self.session_uid)
