...
from Projects.JNJAU_SAND.Utils.KPIToolBox import JNJAUToolBox, log_runtime

__author__ = 'nissand'


class JNJAUGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = JNJAUToolBox(self.data_provider, self.output)
