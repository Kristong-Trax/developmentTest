...
from Projects.PENAFLORAR.Utils.ParseTemplates import parse_template
...
class PENAFLORARDIAGEOARTemplateAsCache:
    ...
    def convert_excel_file(self, file_path):
        if self.template_type == self.DATA_FRAME:
            ...
            data = PENAFLORARDIAGEOARGENERALToolBox.get_json_data(file_path)
        else:
