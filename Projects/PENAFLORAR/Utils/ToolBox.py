...
class PENAFLORARDIAGEOConsts(object):
...
class PENAFLORARDIAGEOToolBox(PENAFLORARDIAGEOConsts):
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOAUPENAFLORARDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOAUPENAFLORARDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOAUPENAFLORARDIAGEOToolBox.DIAGEO
