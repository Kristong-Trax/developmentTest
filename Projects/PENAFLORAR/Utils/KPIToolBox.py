...
from Projects.PENAFLORAR.Utils.Fetcher import PENAFLORARDIAGEOARQueries
from Projects.PENAFLORAR.Utils.GeneralToolBox import PENAFLORARDIAGEOARGENERALToolBox
from Projects.PENAFLORAR.Utils.ToolBox import PENAFLORARDIAGEOToolBox
...
class PENAFLORARDIAGEOARToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = PENAFLORARDIAGEOARGENERALToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
        ...
        self.scores = {self.LEVEL1: {},
                       self.LEVEL2: {},
                       self.LEVEL3: {}}
        self.tools = PENAFLORARDIAGEOToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = PENAFLORARDIAGEOARQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = PENAFLORARDIAGEOARQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = PENAFLORARDIAGEOARQueries.get_delete_session_results_query(self.session_uid)
