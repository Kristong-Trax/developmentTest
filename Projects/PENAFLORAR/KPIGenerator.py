...
from Projects.PENAFLORAR.Utils.KPIToolBox import PENAFLORARDIAGEOARToolBox, log_runtime

__author__ = 'Yasmin'


class PENAFLORARDIAGEOARGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PENAFLORARDIAGEOARToolBox(self.data_provider, self.output)
    ...
    def main_function(self):
        ...
        self.tool_box.main_calculation(set_name=set_names)
