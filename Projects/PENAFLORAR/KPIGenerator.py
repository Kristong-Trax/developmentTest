...
from Projects.PENAFLORAR.Utils.KPIToolBox import PENAFLORARToolBox, log_runtime

__author__ = 'Yasmin'


class PENAFLORARGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = PENAFLORARToolBox(self.data_provider, self.output)
