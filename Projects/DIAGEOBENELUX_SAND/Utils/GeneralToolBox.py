...
from Projects.DIAGEOBENELUX_SAND.Utils.PositionGraph import PositionGraphs

__author__ = 'Nimrod'


class DIAGEOBENELUX_SANDGENERALToolBox:
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDIAGEOBENELUXGENERALToolBox.INCLUDE_FILTER)
