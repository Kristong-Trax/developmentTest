...
from Projects.DIAGEOBENELUX_SAND.Utils.GeneralToolBox import DIAGEOBENELUX_SANDGENERALToolBox
...
class DIAGEOBENELUX_SANDDIAGEOConsts(object):
...
class DIAGEOBENELUX_SANDDIAGEOToolBox(DIAGEOBENELUX_SANDDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOBENELUX_SANDGENERALToolBox(data_provider, output, **data)
