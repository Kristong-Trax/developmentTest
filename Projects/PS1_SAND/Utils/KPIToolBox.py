...
from Projects.PS1_SAND.Data.Const import Const
...
class PS1SandToolBox:
    ...
    def main_calculation(self):
        ...
        self.common_v2.save_json_to_new_tables(assortment_res)
        ...
        results_list = self.diageo_generator.diageo_global_touch_point_function(
            store_attribute=Consts.ADDITIONAL_ATTR_2, template=template, old_tables=True,
            new_tables=False)
        self.save_results_to_db(results_list)
