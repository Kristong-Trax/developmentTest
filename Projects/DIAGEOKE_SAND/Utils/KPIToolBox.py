...
from Projects.DIAGEOKE_SAND.Utils.Fetcher import DIAGEOKE_SANDQueries
from Projects.DIAGEOKE_SAND.Utils.ToolBox import DIAGEOKE_SANDDIAGEOToolBox
...
class DIAGEOKE_SANDToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOKE_SANDDIAGEOToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOKE_SANDQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOKE_SANDQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOKE_SANDQueries.get_delete_session_results_query(self.session_uid)
