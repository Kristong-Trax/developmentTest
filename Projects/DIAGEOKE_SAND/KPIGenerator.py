...
from Projects.DIAGEOKE_SAND.Utils.KPIToolBox import DIAGEOKE_SANDToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOKE_SANDGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOKE_SANDToolBox(self.data_provider, self.output)
