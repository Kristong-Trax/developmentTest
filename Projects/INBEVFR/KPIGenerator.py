...
from Projects.INBEVFR.Utils.KPIToolBox import INBEVFR_PRODINBEVBEToolBox

__author__ = 'urid'


class INBEVFR_PRODINBEVBEGenerator:
    def __init__(self, data_provider, output):
        ...
        self.tool_box = INBEVFR_PRODINBEVBEToolBox(self.data_provider, self.output)
