...
from Projects.INBEVFR.Utils.PositionGraph import INBEVFR_PRODINBEVBEPositionGraphs
from Projects.DIAGEOAU.Utils.GeneralToolBox import DIAGEOAUGENERALToolBox
from Projects.INBEVFR.Utils.GeneralToolBox import INBEVFR_PRODINBEVBEGENERALToolBox
...
class INBEVFR_PRODINBEVBEINBEVToolBox:
    EXCLUDE_FILTER = 0
    INCLUDE_FILTER = 1
    EXCLUDE_EMPTY = 0
    INCLUDE_EMPTY = 1
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = INBEVFR_PRODINBEVBEGENERALToolBox(data_provider, output,
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = INBEVFR_PRODINBEVBEPositionGraphs(self.data_provider)
