...
from Projects.CCUS_SAND.MONSTER.Utils.Fetcher import CCUS_SANDMONSTERQueries
from Projects.CCUS_SAND.MONSTER.Utils.PositionGraph import CCUS_SANDMONSTERPositionGraphs

__author__ = 'Ortal'


class MONSTERGENERALCCUS_SANDToolBox:
    ...
    def get_atts(self):
        ...
        query = CCUS_SANDMONSTERQueries.get_product_atts()
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCUS_SANDMONSTERPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
