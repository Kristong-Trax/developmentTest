...
from Projects.CCUS_SAND.Holiday.Utils.PositionGraph import CCUS_SANDHolidayPositionGraphs

__author__ = 'Ortal'


class CCUS_SANDHolidayGENERALCCUS_SANDToolBox:
    ...
    def get_atts(self):
        ...
        query = CCUS_SANDHolidayQueries.get_product_atts()
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCUS_SANDHolidayPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
