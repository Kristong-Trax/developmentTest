...
from Projects.CCUS_SAND.Programs.Utils.PositionGraph import NEW_CCUS_SANDOBBOPositionGraphs

__author__ = 'Ortal'


class CCUS_SANDNEW_OBBOGENERALCCUS_SANDToolBox:
    ...
    def get_atts(self):
        ...
        query = NEW_CCUS_SANDOBBOQueries.get_product_atts()
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = NEW_CCUS_SANDOBBOPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
