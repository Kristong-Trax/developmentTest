...
import pandas as pd
import os
# from Projects.MSC.Utils.GeneralCCUS_SANDToolBox import CCUS_SANDMSCGENERALCCUS_SANDToolBox  todo: I need this?
...
from Projects.CCUS_SAND.MSC.Utils.GeneralToolBox import CCUS_SANDMSCGENERALCCUS_SANDToolBox
...
class CCUS_SANDMSCCCUS_SANDToolBox:
    LEVEL1 = 1
    LEVEL2 = 2
    LEVEL3 = 3
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = CCUS_SANDMSCGENERALCCUS_SANDToolBox(self.data_provider, self.output, rds_conn=self.rds_conn)
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = CCUS_SANDMSCQueries.get_all_kpi_data()
...
#            groups_list = filter(None, groups_list)
    ...
    def commit_results_data(self,kpi_set_fk=None):
        ...
        if kpi_set_fk is not None:
            query = CCUS_SANDMSCQueries.get_atomic_pk_to_delete(self.session_uid, kpi_set_fk)
        ...
        if kpi_pks and atomic_pks:
            delete_queries = CCUS_SANDMSCQueries.get_delete_session_results_query(self.session_uid, kpi_set_fk, kpi_pks,
                                                                          atomic_pks)
