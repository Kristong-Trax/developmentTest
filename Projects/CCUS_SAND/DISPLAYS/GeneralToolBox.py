...
from Projects.CCUS_SAND.DISPLAYS.PositionGraph import CCUS_SANDDISPLAYSPositionGraphs

__author__ = 'Nimrod'


class DISPLAYSGENERALCCUS_SANDToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCUS_SANDDISPLAYSPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = ('Diageo', DIAGEOAUDISPLAYSGENERALCCUS_SANDToolBox.INCLUDE_FILTER)
