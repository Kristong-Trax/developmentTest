...
from Projects.CCUS_SAND.MSC_NEW.Utils.PositionGraph import CCUS_SANDMSC_NEWPositionGraphs

__author__ = 'Ortal'


class MSC_NEWGENERALCCUS_SANDToolBox:
    ...
    def get_atts(self):
        ...
        query = CCUS_SANDMSC_NEWQueries.get_product_atts()
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = CCUS_SANDMSC_NEWPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
