...
class CCUS_SANDDUNKINJsonGenerator:
    def __init__(self, project):
        self.project = project
        self.base_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'Data')
        self.project_kpi_dict = {'project': self.project, 'author': 'ortal', 'DunkinDonuts': '', 'kpi_data': []}
    ...
    def create_json(self, file_name):
        ...
        self.project_kpi_dict['kpi_data'].append({'DunkinDonuts-kpi': final_json})
