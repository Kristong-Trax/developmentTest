...
class Sequence(BaseCalculation):
    ...
    def __init__(self, data_provider, custom_matches=None, **kwargs):
    ...
    def _initialize_params(self):
        ...
        self._matches = self.data_provider.matches if not self.custom_matches else self.custom_matches
