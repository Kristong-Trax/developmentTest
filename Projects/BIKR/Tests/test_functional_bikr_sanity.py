...
from Projects.BIKR.Tests.Data.data_test_bikr_sanity import ProjectsSanityData
from Projects.BIKR.Calculations import BIKRCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.BIKR.Tests.Data.kpi_results import BIKRKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    @PsSanityTestsFuncs.seeder.seed(["bikr_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_bikr_sanity(self):
        self.add_mocks()
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'3CFE85E1-6A89-4850-9A4E-DF2BD7634892': []}
        kpi_results = BIKRKpiResults().get_kpi_results()
