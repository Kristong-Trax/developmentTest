...
from Projects.DIAGEORU_SAND.Utils.GeneralToolBox import DIAGEORUGENERALToolBox
...
class DIAGEORUDIAGEOConsts(object):
...
class DIAGEORUDIAGEOToolBox(DIAGEORUDIAGEOConsts):
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEORUGENERALToolBox(data_provider, output, **data)
