...
class Consts(object):
    ...
    CONTROL = 'CONTROL'
    NOT_INDEPENDENT_STORES = [OPEN, NATIONAL_STORE, INDEPENDENT, CONTROL]
    # sheets:
    ...
    SHEETS = {
        ...
        CONTROL: {ON: [ON_TRADE_INDEPENDENT], OFF: [
            OFF_TRADE_INDEPENDENT, MINIMUM_SHELF_SHEET, SHELF_GROUPS_SHEET]}}
    # KPIs columns:
    ...
    EX_REQUIRED_NON_CASES, EX_REQUIRED_CASES, = "required non cases", "required cases"
    EX_REQUIRED_BOTTLES, EX_MIN_COMBINED_FACINGS = "required bottles", "minimum combined facings"
    ...
    DISPLAY_TARGET_COLUMNS = [EX_SCENE_TYPE, EX_PRODUCT_FK, EX_MIN_FACINGS, EX_ATTR2,
                              EX_REQUIRED_NON_CASES, EX_REQUIRED_CASES, EX_REQUIRED_BOTTLES, EX_MIN_COMBINED_FACINGS]

    ALL = "ALL"

    MENU_EXCLUDE_SUB_CATEGORIES = ["SPIRIT DRINK", "COCKTAIL", "LIQUEUR"]
    MENU_EXCLUDE_CATEGORIES = ["MENU"]
    MENU_EXCLUDE_MANUFACTURERS = ["Spirits Other"]
