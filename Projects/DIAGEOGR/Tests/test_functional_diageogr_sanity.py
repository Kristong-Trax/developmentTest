...
from Projects.DIAGEOGR.Tests.Data.data_test_diageogr_sanity import ProjectsSanityData
from Projects.DIAGEOGR.Calculations import DIAGEOGRCalculations
from DevloperTools.SanityTests.PsSanityTests import PsSanityTestsFuncs
from Projects.DIAGEOGR.Tests.Data.kpi_results import DIAGEOGRKpiResults
# import os
# import json
...
class TestKEnginePsCode(PsSanityTestsFuncs):
    ...
    def test_diageogr_sanity(self):
        ...
        sessions = {'e18b8fbd-3dd1-417c-a5f3-cd98a8e8bec4': []}
