...
from Projects.DIAGEOGR.Utils.KPIToolBox import DIAGEOGRToolBox, log_runtime

__author__ = 'Nimrod'


class DIAGEOGRGenerator:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tool_box = DIAGEOGRToolBox(self.data_provider, self.output)
