...
from Projects.DIAGEOGR.Utils.Fetcher import DIAGEOGRQueries
from Projects.DIAGEOGR.Utils.ToolBox import DIAGEOGRDIAGEOToolBox
...
class DIAGEOGRToolBox:
    ...
    def __init__(self, data_provider, output):
        ...
        self.tools = DIAGEOGRDIAGEOToolBox(self.data_provider, output,
    ...
    def get_kpi_static_data(self):
        ...
        """
        query = DIAGEOGRQueries.get_all_kpi_data()
    ...
    def get_match_display(self):
        ...
        """
        query = DIAGEOGRQueries.get_match_display(self.session_uid)
    ...
    def commit_results_data(self):
        ...
        delete_queries = DIAGEOGRQueries.get_delete_session_results_query(self.session_uid)
