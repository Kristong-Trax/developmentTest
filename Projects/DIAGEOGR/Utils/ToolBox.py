...
from Projects.DIAGEOGR.Utils.GeneralToolBox import DIAGEOGRGENERALToolBox
...
class DIAGEOGRDIAGEOToolBox:
    ...
    def __init__(self, data_provider, output, **data):
        ...
        self.general_tools = DIAGEOGRGENERALToolBox(data_provider, output, self.kpi_static_data,
    ...
    def get_filter_condition(self, df, **filters):
        ...
        :param filters: These are the parameters which the data frame is filtered by.
                       ...
                       INPUT EXAMPLE (1):   manufacturer_name = (DIAGEOGRDIAGEOToolBox.DIAGEO,
                                                                 DIAGEOGRDIAGEOToolBox.INCLUDE_FILTER)
                       INPUT EXAMPLE (2):   manufacturer_name = DIAGEOGRDIAGEOToolBox.DIAGEO
