...
if __name__ == '__main__':
    ...
    session_and_scenes = {
        ...
        # "00006BEC-3629-4ED3-BCB9-0242A3C90472":	[
        #     1300604, 1300619, 1300647,	1300665, 1300683, 1300695, 1300704,	1300708, 1300720, 1300737, 1300754, 1300765,
        #     1300783, 1300804, 1300848, 1300853, 1300877, 1300882, 1300920, 1300970, 1301017, 1301034],
    ...
    for session, scenes in session_and_scenes.items():
        data_provider.load_session_data(session)
        scenes += data_provider['scene_item_facts'].unique().tolist()

        for scene in scenes:
            data_provider.load_scene_data(session, scene)
            # data_provider.load_scene_data(session, session_and_scenes[session][scene][0],
