...
class LAVAZZAFR_SANDCalculations(BaseCalculationsScript):
...
#     Config.init()
#     project_name = 'lavazzafr_sand'
#     data_provider = KEngineDataProvider(project_name)
#     session = '64cf60ed-42b6-4275-b7ca-95d23b87dee4'
#     data_provider.load_session_data(session)
#     output = Output()
#     LAVAZZAFR_SANDCalculations(data_provider, output).run_project_calculations()