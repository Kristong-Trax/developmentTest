...
from Projects.PEPSICOBR.Utils.PositionGraph import PEPSICOBRPositionGraphs

__author__ = 'Nimrod'


class PEPSICOBRGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = PEPSICOBRPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
