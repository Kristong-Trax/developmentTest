...
from Projects.PEPSICOBR_SAND.Utils.PositionGraph import PEPSICOBR_SANDPositionGraphs
...
class PEPSICOBR_SANDGENERALToolBox:
    ...
    def position_graphs(self):
        if not hasattr(self, '_position_graphs'):
            self._position_graphs = PEPSICOBR_SANDPositionGraphs(self.data_provider, rds_conn=self.rds_conn)
