...
from Tests.Data.TestData.test_data_ccru_sand_sanity import ProjectsSanityData
from Projects.CCRU_SAND.RedScoreCalculation import CCRU_SANDCalculations
...
class TestKEngineOutOfTheBox(MockingTestCase):
    ...
    @seeder.seed(["ccru_sand_seed"], ProjectsSanityData())
    def test_ccru_sand_sanity(self):
