...
from Tests.Data.Templates.diageoie_template import diageoie_template
...
class TestKEngineOutOfTheBox(MockingTestCase):
    ...
    @patch('Projects.DIAGEOIE.Utils.ToolBox.DIAGEOIEDIAGEOToolBox.get_latest_directory_date_from_cloud',
           return_value='2018-05-18')
    @patch('Projects.DIAGEOIE.Utils.ToolBox.DIAGEOIEDIAGEOToolBox.save_latest_templates')
    @patch('Projects.DIAGEOIE.Utils.ToolBox.DIAGEOIEDIAGEOToolBox.download_template',
           return_value=diageoie_template)
    @seeder.seed(["diageoie_seed"], ProjectsSanityData())
    def test_diageoie_sanity(self, x, y, json):
