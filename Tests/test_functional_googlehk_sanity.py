...
from Tests.Data.TestData.test_data_googlehk_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["googlehk_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_googlehk_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'D4CF1290-635F-4032-B0A8-1824F3BD2E57': []}
