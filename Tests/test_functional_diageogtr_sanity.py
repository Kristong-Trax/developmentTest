...
# from Tests.Data.TestData.test_data_diageogtest_data_diageogtr_sanity import ProjectsSanityData
# from Projects.DIAGEOGTR.Calculations import DIAGEOGTRCalculations
#
...
#         connector.disconnect_rds()
#
#     @seeder.seed(["diageogtr_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
#     def test_diageogtr_sanity(self):
#         project_name = ProjectsSanityData.project_name
#         data_provider = KEngineDataProvider(project_name)
#         sessions = {'86897df1-2ca2-4175-b543-06f025266fc2': []}
