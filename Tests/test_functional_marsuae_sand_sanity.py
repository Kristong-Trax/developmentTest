...
from Tests.Data.TestData.test_data_marsuae_sand_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["marsuae_sand_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_marsuae_sand_sanity(self):
