...
from Tests.Data.TestData.test_data_googlesg_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["googlesg_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_googlesg_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'585509C6-827B-4FB2-B6FE-CE2B1F0BF60A': []}
