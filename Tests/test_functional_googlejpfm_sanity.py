...
from Tests.Data.TestData.test_data_googlejpfm_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["googlejpfm_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_googlejpfm_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'cdeb74a6-ac41-4f07-bad5-f53a9c0f25f8': []}
