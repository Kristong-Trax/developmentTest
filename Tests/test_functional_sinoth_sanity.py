...
from Tests.Data.TestData.test_data_sinoth_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["sinoth_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_sinoth_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {u'7ECDBD5C-B82F-43EE-B48A-693FE5F1F136': []}
