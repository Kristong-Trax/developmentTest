...
from Tests.Data.TestData.test_data_googlebr_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["googlebr_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_googlebr_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'2e4e7824-2d82-4eed-ac18-de3d8bcbb5e4': []}
