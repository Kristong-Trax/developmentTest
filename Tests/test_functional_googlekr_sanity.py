...
from Tests.Data.TestData.test_data_googlekr_sanity import ProjectsSanityData
...
class TestKEngineOutOfTheBox(TestFunctionalCase):
    ...
    @seeder.seed(["googlekr_seed", "mongodb_products_and_brands_seed"], ProjectsSanityData())
    def test_googlekr_sanity(self):
        project_name = ProjectsSanityData.project_name
        data_provider = KEngineDataProvider(project_name)
        sessions = {'1CD285CE-F859-401E-BE2A-987CDB604A1B': []}
