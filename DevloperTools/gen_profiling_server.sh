...
cd .. && python -m cProfile -o 1.stats ~/dev/trax_ace_factory_for_profiling/Projects/$1/Calculations.py -e prod -c ~/dev/theGarage/Trax/Apps/Services/KEngine/k-engine-prod.config
