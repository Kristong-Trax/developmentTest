...
def copy_sanity_tests_infra_to_ace_live(ace_live_folder, kpi_factory_folder):
    if os.path.exists(os.path.join(ace_live_folder, DEVELOPER_TOOLS_FOLDER)):
        shutil.rmtree(os.path.join(ace_live_folder, DEVELOPER_TOOLS_FOLDER))
    ...
    shutil.copyfile(os.path.join(kpi_factory_folder, DEVELOPER_TOOLS_FOLDER, INIT_FILE),
                    os.path.join(ace_live_folder, DEVELOPER_TOOLS_FOLDER, INIT_FILE))
...
def copy_to_ace_live(sdk_factory_folder, ace_live_folder, kpi_factory_folder=None, project_name=None):
    ...
    copy_sanity_tests_infra_to_ace_live(ace_live_folder, kpi_factory_folder)
